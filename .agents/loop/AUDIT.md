...
- **FRD ambiguity (recorded)**: All 14 module FRDs read — no unimplemented requirements flagged with "to implement", "will add", "future", or "TODO" markers in the FRD text itself.
