...
- [modules/security/pyproject.toml](<modules/security/pyproject.toml>)
...
## File: modules/security/pyproject.toml

```toml
[project]
name = "blender-arwaky-security"
version = "1.7.0"
description = "BlenderArwaky security and validation module"
...
## File: modules/shared/src/security/utility_security_path.py
