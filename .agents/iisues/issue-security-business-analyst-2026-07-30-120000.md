...
class ArchiveGuard(ExtractArchiveProtocol):
    ...
    async def validate_extraction(self, request: ArchiveExtractionVO) -> ArchiveExtractionVO:
        ...
        allowed_dirs = list(
            self._policy.extract_allowed_directories
            or self._policy.allowed_directories
        )
