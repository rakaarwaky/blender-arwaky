"""Shared test fixtures for the launcher feature test suite.

Mirror the security/config shim: ``modules.shared.src.__init__`` is currently
broken (missing ``mcp`` subpackage) and must be shimmed before import.
"""
