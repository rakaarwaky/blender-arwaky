...
class TestDefaultKeyPatterns:
    ...
    def test_private_key_redacted(self) -> None:
        ...
        assert "my-private-key" not in res.text  # nosec B101
    ...
    def test_auth_key_redacted(self) -> None:
        ...
        assert "myauthvalue" not in res.text  # nosec B101
    ...
    def test_credential_key_redacted(self) -> None:
        ...
        assert "mycred" not in res.text  # nosec B101
    ...
    def test_session_key_redacted(self) -> None:
        ...
        assert "sess123" not in res.text  # nosec B101
    ...
    def test_cookie_key_redacted(self) -> None:
        ...
        assert "cookietoken" not in res.text  # nosec B101
...
class TestPatternBasedRedaction:
    ...
    def test_bearer_token_redacted(self) -> None:
        ...
        assert "eyJhbGciOiJIUzI1NiIs" not in res.text  # nosec B101
    ...
    def test_basic_auth_redacted(self) -> None:
        ...
        assert "dXNlcjpwYXNz" not in res.text  # nosec B101
    ...
    def test_sk_pattern_redacted(self) -> None:
        ...
        assert "sk-abcdefghijklmnopqrstuvwxyz123456" not in res.text  # nosec B101
    ...
    def test_ghp_pattern_redacted(self) -> None:
        ...
        assert "ghp_ABCDEFGHIJKLMNOPqrstuv1234567890" not in res.text  # nosec B101
...
class TestCustomKeyNames:
    ...
    def test_custom_key_redacted(self) -> None:
        ...
        assert "abc123" not in res.text  # nosec B101
    ...
    def test_custom_key_case_insensitive(self) -> None:
        ...
        assert "value123" not in res.text  # nosec B101
    ...
    def test_custom_key_json_form(self) -> None:
        ...
        assert "tok-abc123" not in res.text  # nosec B101
...
class TestKeyAndValueForms:
    ...
    def test_shell_form_redacted(self) -> None:
        ...
        assert "secret123" not in res.text  # nosec B101
    ...
    def test_json_form_with_api_key(self) -> None:
        ...
        assert "sk-abcdefghijklmnopqrst" not in res.text  # nosec B101
    ...
    def test_spaced_quoted_secret_redacted(self) -> None:
        ...
        assert "my secret value" not in res.text  # nosec B101
        assert "secret" not in res.text  # no partial leak  # nosec B101
    ...
    def test_spaced_json_secret_redacted(self) -> None:
        ...
        assert "sk-1 2 3" not in res.text  # nosec B101
...
class TestRedactionOutput:
    ...
    def test_text_equals_redacted_text(self) -> None:
        ...
        assert res.text == res.redacted_text  # nosec B101
    ...
    def test_redacted_count_increments(self) -> None:
        ...
        assert res.redacted_count >= 2  # nosec B101
...
class TestFailureMasking:
    ...
    def test_failure_masks_entire_payload(self) -> None:
        ...
        assert res.failed is True  # nosec B101
        assert res.text == "[REDACTION_FAILED]"  # nosec B101
        assert res.redacted_text == "[REDACTION_FAILED]"  # nosec B101
    ...
    def test_failure_has_failure_reason(self) -> None:
        ...
        assert res.failed is True  # nosec B101
        assert res.failure_reason is not None  # nosec B101
...
class TestEdgeCases:
    ...
    def test_no_secrets_in_text(self) -> None:
        ...
        assert res.text == "This is a normal message with no secrets"  # nosec B101

    def test_empty_text(self) -> None:
        """FR-SEC-004: empty text is handled."""
        cap = _make_redactor()
        res = _redact(cap, "")
        assert res.text == ""  # nosec B101
        assert res.redacted_count == 0  # nosec B101
    ...
    def test_binary_data_handling(self) -> None:
        ...
        # Should not raise
        assert res.failed is False  # nosec B101
    ...
    def test_nested_structure_redacted(self) -> None:
        ...
        assert "hunter2" not in res.text  # nosec B101
        assert "sk-abcdefghijklmnop" not in res.text  # nosec B101
    ...
    def test_sensitive_path_in_message(self) -> None:
        ...
        assert "secret" not in res.text  # nosec B101
    ...
    def test_token_in_query_parameter(self) -> None:
        ...
        assert "abc123xyz" not in res.text  # nosec B101
    ...
    def test_multiline_secret_redacted(self) -> None:
        ...
        assert "line1" not in res.text  # nosec B101
        assert "line2" not in res.text  # nosec B101
    ...
    def test_near_key_word_is_not_false_positive(self) -> None:
        ...
        assert res.text == "tokenize this normal message"  # nosec B101
...
class TestSensitivityLevels:
    ...
    def test_high_sensitivity(self) -> None:
        ...
        assert res.sensitivity_level == SensitivityLevel.HIGH  # nosec B101
    ...
    def test_critical_sensitivity(self) -> None:
        ...
        assert res.sensitivity_level == SensitivityLevel.CRITICAL  # nosec B101
    ...
    def test_low_sensitivity(self) -> None:
        ...
        assert res.sensitivity_level == SensitivityLevel.LOW  # nosec B101
...
class TestRepresentation:
    ...
    def test_sensitive_redactor_repr(self) -> None:
        ...
        assert "SensitiveRedactor" in repr(cap)  # nosec B101
