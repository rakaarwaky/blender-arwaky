...
def _make_validator(policy: SecurityPolicyVO | None = None) -> PathValidator:
    """Create a PathValidator with optional policy."""
...
class TestEmptyPathValidation:
    ...
    def test_empty_string_path_rejected(self) -> None:
        ...
        cap = _make_validator()
        result = PathValidator.__init__(cap, SecurityPolicyVO())
        import asyncio
    ...
    def test_whitespace_only_path_rejected(self) -> None:
        ...
        cap = _make_validator()
        PathValidator.__init__(cap, SecurityPolicyVO())
        import asyncio
...
class TestPathTraversalDetection:
    ...
    def test_simple_traversal_rejected(self) -> None:
        ...
        PathValidator.__init__(cap, _make_policy(allowed_directories=("/safe",)))
        import asyncio
...
class TestAllowedDirectories:
    ...
    def test_multiple_allowed_directories(self) -> None:
        ...
        PathValidator.__init__(cap, _make_policy(allowed_directories=("/safe", "/tmp/build")))
        import asyncio
    ...
    def test_no_allowed_directories_accepts_all(self) -> None:
        ...
        PathValidator.__init__(cap, _make_policy(allowed_directories=[]))
        import asyncio
...
class TestSymlinkHandling:
    ...
    def test_symlink_escape_detected(self) -> None:
        ...
        PathValidator.__init__(cap, _make_policy(allowed_directories=("/safe",)), mock_resolver)
        import asyncio
...
class TestCanonicalPath:
    ...
    def test_canonical_path_normalized(self) -> None:
        ...
        assert res.allowed is True
        assert "project" not in res.canonical_path or ".." not in res.canonical_path
