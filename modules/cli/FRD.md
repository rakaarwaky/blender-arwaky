...
| `install-plugin` | `--plugin-id` **required**, `--sha256` **required**, `--cache-path` **required**, `--blender-path` **required**, `--repository-id`, `--extension-id` **required**, `--enable` | `install_plugin` | `plugin` |
| `enable-plugin` | `--plugin-id` **required**, `--sha256` **required**, `--cache-path` **required**, `--blender-path` **required**, `--repository-id`, `--extension-id` **required** | `enable_plugin` | `plugin` |
| `disable-plugin` | `--plugin-id` **required**, `--blender-path` **required**, `--extension-id` **required**, `--confirm` | `disable_plugin` | `plugin` |
| `remove-plugin` | `--plugin-id` **required**, `--blender-path` **required**, `--extension-id` **required**, `--confirm` | `remove_plugin` | `plugin` |
