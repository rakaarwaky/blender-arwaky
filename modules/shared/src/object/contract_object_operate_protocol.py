...
class ContractObjectOperateProtocol(ABC):
    ...
    async def delete_object(
        self, request: DeleteObjectRequestVO
    ) -> DeleteObjectResponseVO:
    ...
    async def create_primitive(
        self, request: CreatePrimitiveRequestVO
    ) -> CreatePrimitiveResponseVO:
    ...
    async def set_material(
        self, request: SetMaterialRequestVO
    ) -> SetMaterialResponseVO:
    ...
    async def apply_modifier(
        self, request: ApplyModifierRequestVO
    ) -> ApplyModifierResponseVO:
