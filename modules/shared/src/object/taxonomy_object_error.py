...
class TransformLockError(DomainError):
    ...
    def __init__(self, channel: ErrorString) -> None:
...
class ModifierActionConfirmationError(DomainError):
    ...
    def __init__(self, modifier_name: ErrorString, action: ErrorString) -> None:
...
class DeletionProtectionError(DomainError):
    ...
    def __init__(self, object_name: ObjectName, protected_category: ErrorString) -> None:
...
class InvalidPrimitiveTypeError(DomainError):
    ...
    def __init__(self, primitive_type: ErrorString) -> None:
...
class InvalidModifierTypeError(DomainError):
    ...
    def __init__(self, modifier_type: ErrorString) -> None:
