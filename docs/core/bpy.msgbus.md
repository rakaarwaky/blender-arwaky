...
owner (Any) – The owner handle passed to `subscribe_rna()`.

      bpy.msgbus.publish_rna(*, key)  Parameters: 

key ([`bpy.types.Property`](bpy.types.Property.html#bpy.types.Property) | [`bpy.types.Struct`](bpy.types.Struct.html#bpy.types.Struct) | tuple[[`bpy.types.Struct`](bpy.types.Struct.html#bpy.types.Struct), str]) – 
...
- args (tuple) – Arguments passed to the callback. 
- notify (Callable[..., None]) – The callback function. 
...
All subscribers will be cleared on file-load. Subscribers can be re-registered on load, see [`bpy.app.handlers.load_post`](bpy.app.handlers.html#bpy.app.handlers.load_post).
