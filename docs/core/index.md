...
Welcome to the Python API documentation for [Blender](https://www.blender.org), the free and open source 3D creation suite.

 

This site can be used offline: [Download the full documentation (zipped HTML files)](blender_python_reference_5_2.zip)
...
- [Contribute Documentation](info_contributing.html): Guide for contributing to Blender’s Python API documentation.   
...
- [ID Properties Module (idprop)](idprop.html) 
