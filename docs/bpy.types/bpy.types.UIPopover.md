...
base class — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)
   ...
   class bpy.types.UIPopover(bpy_struct)   layout 
...
- [`WindowManager.popover_begin__internal`](bpy.types.WindowManager.html#bpy.types.WindowManager.popover_begin__internal)   
