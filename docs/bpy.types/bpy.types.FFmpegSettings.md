...
- `CUSTOM` Custom Quality – Set a custom Constant Rate Factor (CRF)..   Type: 
...
- `REALTIME` Realtime – Recommended for fast encoding.   Type: 
...
- [`RenderSettings.ffmpeg`](bpy.types.RenderSettings.html#bpy.types.RenderSettings.ffmpeg)
