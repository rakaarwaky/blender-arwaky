...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`CompositorNode`](bpy.types.CompositorNode.html#bpy.types.CompositorNode)
   ...
   class bpy.types.CompositorNodeRelativeToPixel(CompositorNode) 

Converts values that are relative to the image size to be in terms of pixels

   data_type 

The type of data (default `'FLOAT'`)

  
- `FLOAT` Float – Float value. 
- `VECTOR` Vector – Vector value.   Type: 

Literal[‘FLOAT’, ‘VECTOR’]

      reference_dimension 

Defines the dimension of the image that the relative value is in reference to (default `'X'`)
...
- `Diagonal` Diagonal – The value is relative to the diagonal of the image.   Type: 
