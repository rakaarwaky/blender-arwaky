...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`CompositorNode`](bpy.types.CompositorNode.html#bpy.types.CompositorNode)
   ...
   class bpy.types.CompositorNodeSeparateColor(CompositorNode) 
...
- `YUV` YUV – Use YUV (Y - luma, U V - chroma) color processing.   Type: 

Literal[‘RGB’, ‘HSV’, ‘HSL’, ‘YCC’, ‘YUV’]

      ycc_mode 

Color space used for YCbCrA processing (default `'ITUBT601'`)

  Type: 

Literal[‘ITUBT601’, ‘ITUBT709’, ‘JFIF’]
