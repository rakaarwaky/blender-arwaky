...
- particle ([`Particle`](bpy.types.Particle.html#bpy.types.Particle) | None) – hair particle (never None)   Returns: 
...
- object ([`Object`](bpy.types.Object.html#bpy.types.Object) | None) – Object (never None) 
- modifier ([`ParticleSystemModifier`](bpy.types.ParticleSystemModifier.html#bpy.types.ParticleSystemModifier) | None) – Particle modifier (never None) 
- particle ([`Particle`](bpy.types.Particle.html#bpy.types.Particle) | None) – hair particle (never None) 
- co ([`mathutils.Vector`](mathutils.html#mathutils.Vector) | Sequence[float]) – Co, Specified hairkey location (array of 3 items, in [-inf, inf])       classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
...
- [`Particle.hair_keys`](bpy.types.Particle.html#bpy.types.Particle.hair_keys)
