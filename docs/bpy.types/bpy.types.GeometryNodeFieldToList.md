# bpy.types.GeometryNodeFieldToList

# GeometryNodeFieldToList(GeometryNode)
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeFieldToList(GeometryNode) 
...
[`GeometryNodeFieldToListItem`](bpy.types.GeometryNodeFieldToListItem.html#bpy.types.GeometryNodeFieldToListItem) | None
...
[`GeometryNodeFieldToListItems`](bpy.types.GeometryNodeFieldToListItems.html#bpy.types.GeometryNodeFieldToListItems)[[`GeometryNodeFieldToListItem`](bpy.types.GeometryNodeFieldToListItem.html#bpy.types.GeometryNodeFieldToListItem)]
