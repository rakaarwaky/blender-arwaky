...
[`AttributeGroupPointCloud`](bpy.types.AttributeGroupPointCloud.html#bpy.types.AttributeGroupPointCloud)[[`Attribute`](bpy.types.Attribute.html#bpy.types.Attribute)]
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`Point`](bpy.types.Point.html#bpy.types.Point)]
...
- [`BlendData.pointclouds`](bpy.types.BlendData.html#bpy.types.BlendData.pointclouds)   
- [`BlendDataPointClouds.new`](bpy.types.BlendDataPointClouds.html#bpy.types.BlendDataPointClouds.new) 
- [`BlendDataPointClouds.remove`](bpy.types.BlendDataPointClouds.html#bpy.types.BlendDataPointClouds.remove)
