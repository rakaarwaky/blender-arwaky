# bpy.types.GeometryNodeSampleCurve
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeSampleCurve(GeometryNode) 
...
Method for sampling input (default `'FACTOR'`)

  
- `FACTOR` Factor – Find sample positions on the curve using a factor of its total length. 
- `LENGTH` Length – Find sample positions on the curve using a distance from its beginning.   Type: 

Literal[‘FACTOR’, ‘LENGTH’]

      use_all_curves 

Sample lengths based on the total length of all curves, rather than using a length inside each selected curve (default False)
