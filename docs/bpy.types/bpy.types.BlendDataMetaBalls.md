...
Remove a metaball from the current blendfile
  ...
  Parameters:  
- metaball ([`MetaBall`](bpy.types.MetaBall.html#bpy.types.MetaBall) | None) – Metaball to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this metaball data (optional)       tag(value) 
