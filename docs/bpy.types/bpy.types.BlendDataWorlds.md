...
Remove a world from the current blendfile
  ...
  Parameters:  
- world ([`World`](bpy.types.World.html#bpy.types.World) | None) – World to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this world (optional)       tag(value) 
