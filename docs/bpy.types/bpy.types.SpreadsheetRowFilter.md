...
base class — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)
   ...
   class bpy.types.SpreadsheetRowFilter(bpy_struct)   column_name 
...
- [`SpaceSpreadsheet.row_filters`](bpy.types.SpaceSpreadsheet.html#bpy.types.SpaceSpreadsheet.row_filters)
