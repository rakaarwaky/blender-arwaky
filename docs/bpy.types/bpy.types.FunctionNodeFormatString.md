...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`FunctionNode`](bpy.types.FunctionNode.html#bpy.types.FunctionNode)
   ...
   class bpy.types.FunctionNodeFormatString(FunctionNode) 
...
[`NodeFunctionFormatStringItems`](bpy.types.NodeFunctionFormatStringItems.html#bpy.types.NodeFunctionFormatStringItems)[[`NodeFunctionFormatStringItem`](bpy.types.NodeFunctionFormatStringItem.html#bpy.types.NodeFunctionFormatStringItem)]
