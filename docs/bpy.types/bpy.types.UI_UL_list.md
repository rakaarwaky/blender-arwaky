...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`UIList`](bpy.types.UIList.html#bpy.types.UIList)
   ...
   class bpy.types.UI_UL_list(UIList)   static filter_items_by_name(pattern, bitflag, items, propname='name', flags=None, reverse=False) 
...
- reverse (bool) – Invert the match (set the bit on non-matching items).   Returns: 
...
- propname (str) – Name of the string property on each item to sort by.   Returns: 
...
- reverse (bool) – Reverse the sort order.   Returns: 
