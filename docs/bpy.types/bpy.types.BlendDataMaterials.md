...
material ([`Material`](bpy.types.Material.html#bpy.types.Material) | None) – Material (never None)
...
Remove a material from the current blendfile
  ...
  Parameters:  
- material ([`Material`](bpy.types.Material.html#bpy.types.Material) | None) – Material to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this material (optional)       tag(value) 
