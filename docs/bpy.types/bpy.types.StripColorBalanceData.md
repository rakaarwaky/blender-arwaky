...
- [StripColorBalance(StripColorBalanceData)](bpy.types.StripColorBalance.html)     class bpy.types.StripColorBalanceData(bpy_struct) 
...
- `OFFSET_POWER_SLOPE` Offset/Power/Slope (ASC-CDL) – ASC-CDL standard color correction.   Type: 
...
- [`ColorBalanceModifier.color_balance`](bpy.types.ColorBalanceModifier.html#bpy.types.ColorBalanceModifier.color_balance)
