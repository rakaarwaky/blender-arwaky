...
- frame (int) – The frame for the new marker (in [-1048574, 1048574], optional)   Returns: 
...
marker ([`TimelineMarker`](bpy.types.TimelineMarker.html#bpy.types.TimelineMarker) | None) – Timeline marker to remove (never None)
