...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`CompositorNode`](bpy.types.CompositorNode.html#bpy.types.CompositorNode)
...
The directory where the image will be written (default “”, never None, blend relative `//` prefix supported, Supports [template expressions](https://docs.blender.org/manual/en/5.2/files/file_paths.html#path-templates))
...
The base name of the file. Other information might be included in the final file name depending on the node options (default “”, never None, Supports [template expressions](https://docs.blender.org/manual/en/5.2/files/file_paths.html#path-templates))
...
[`NodeCompositorFileOutputItems`](bpy.types.NodeCompositorFileOutputItems.html#bpy.types.NodeCompositorFileOutputItems)[[`NodeCompositorFileOutputItem`](bpy.types.NodeCompositorFileOutputItem.html#bpy.types.NodeCompositorFileOutputItem)]
...
[`ImageFormatSettings`](bpy.types.ImageFormatSettings.html#bpy.types.ImageFormatSettings) | None
...
- `CompositorNode.poll` 
- [`CompositorNode.bl_rna_get_subclass`](bpy.types.CompositorNode.html#bpy.types.CompositorNode.bl_rna_get_subclass) 
- [`CompositorNode.bl_rna_get_subclass_py`](bpy.types.CompositorNode.html#bpy.types.CompositorNode.bl_rna_get_subclass_py)
