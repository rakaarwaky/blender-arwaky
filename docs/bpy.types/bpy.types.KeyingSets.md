...
[`KeyingSet`](bpy.types.KeyingSet.html#bpy.types.KeyingSet) | None
...
- name (str) – Name, User visible name of Keying Set (optional, never None)   Returns: 

Newly created Keying Set

  Return type: 

[`KeyingSet`](bpy.types.KeyingSet.html#bpy.types.KeyingSet)
