...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeViewer(GeometryNode) 
...
[`NodeGeometryViewerItem`](bpy.types.NodeGeometryViewerItem.html#bpy.types.NodeGeometryViewerItem) | None
...
Literal[[Attribute Domain With Auto Items](bpy_types_enum_items/attribute_domain_with_auto_items.html#rna-enum-attribute-domain-with-auto-items)]
...
[`NodeGeometryViewerItems`](bpy.types.NodeGeometryViewerItems.html#bpy.types.NodeGeometryViewerItems)[[`NodeGeometryViewerItem`](bpy.types.NodeGeometryViewerItem.html#bpy.types.NodeGeometryViewerItem)]
