# bpy.types.AnnotationStrokePoints
...
- strength (float) – Strength, Color strength/opacity for new points (in [0, 1], optional)       remove(index) 
...
- [`AnnotationStroke.points`](bpy.types.AnnotationStroke.html#bpy.types.AnnotationStroke.points)
