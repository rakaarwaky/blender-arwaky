...
[`MetaElement`](bpy.types.MetaElement.html#bpy.types.MetaElement) | None
...
type (Literal[[Metaelem Type Items](bpy_types_enum_items/metaelem_type_items.html#rna-enum-metaelem-type-items)]) – Type for the new metaball element (optional)
...
[`MetaElement`](bpy.types.MetaElement.html#bpy.types.MetaElement)
...
element ([`MetaElement`](bpy.types.MetaElement.html#bpy.types.MetaElement) | None) – The element to remove (never None)
