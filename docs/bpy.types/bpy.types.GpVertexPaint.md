...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Paint`](bpy.types.Paint.html#bpy.types.Paint)
   ...
   class bpy.types.GpVertexPaint(Paint)   classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
...
- [`ToolSettings.gpencil_vertex_paint`](bpy.types.ToolSettings.html#bpy.types.ToolSettings.gpencil_vertex_paint)
