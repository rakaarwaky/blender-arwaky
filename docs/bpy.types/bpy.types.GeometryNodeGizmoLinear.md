# bpy.types.GeometryNodeGizmoLinear
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeGizmoLinear(GeometryNode) 
...
Literal[[Geometry Nodes Gizmo Color Items](bpy_types_enum_items/geometry_nodes_gizmo_color_items.html#rna-enum-geometry-nodes-gizmo-color-items)]
...
Literal[[Geometry Nodes Linear Gizmo Draw Style Items](bpy_types_enum_items/geometry_nodes_linear_gizmo_draw_style_items.html#rna-enum-geometry-nodes-linear-gizmo-draw-style-items)]
