...
- exact (bool) – Exact, Get marker at exact frame number rather than get estimated marker (optional)   Returns: 

Marker for specified frame

  Return type: 

[`MovieTrackingMarker`](bpy.types.MovieTrackingMarker.html#bpy.types.MovieTrackingMarker)
...
- co ([`mathutils.Vector`](mathutils.html#mathutils.Vector) | Sequence[float]) – Coordinate, Place new marker at the given frame using specified in normalized space coordinates (array of 2 items, in [-1, 1], optional)   Returns: 
...
- [`MovieTrackingTrack.markers`](bpy.types.MovieTrackingTrack.html#bpy.types.MovieTrackingTrack.markers)
