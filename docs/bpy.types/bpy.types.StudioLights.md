...
- type (Literal['STUDIO', 'WORLD', 'MATCAP']) – Type, The type for the new studio light   Returns: 

Newly created StudioLight

  Return type: 

[`StudioLight`](bpy.types.StudioLight.html#bpy.types.StudioLight)
...
studio_light ([`StudioLight`](bpy.types.StudioLight.html#bpy.types.StudioLight) | None) – The studio light to remove (never None)
