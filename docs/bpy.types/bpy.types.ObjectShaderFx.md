...
- type (Literal[[Object Shaderfx Type Items](bpy_types_enum_items/object_shaderfx_type_items.html#rna-enum-object-shaderfx-type-items)]) – Effect type to add   Returns: 

Newly created effect

  Return type: 

[`ShaderFx`](bpy.types.ShaderFx.html#bpy.types.ShaderFx)
...
shader_fx ([`ShaderFx`](bpy.types.ShaderFx.html#bpy.types.ShaderFx) | None) – Effect to remove (never None)
