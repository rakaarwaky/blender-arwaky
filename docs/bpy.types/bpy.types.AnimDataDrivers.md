...
driver ([`FCurve`](bpy.types.FCurve.html#bpy.types.FCurve) | None) – (never None)
...
src_driver ([`FCurve`](bpy.types.FCurve.html#bpy.types.FCurve) | None) – Existing Driver F-Curve to use as template for a new one (optional)
