# bpy.types.BlendImportContextItem
...
- `COPY_LOCAL` The linked ID had other unrelated usages, so it has been duplicated into a local copy.   Type: 
...
[`BlendImportContextLibraries`](bpy.types.BlendImportContextLibraries.html#bpy.types.BlendImportContextLibraries)[[`BlendImportContextLibrary`](bpy.types.BlendImportContextLibrary.html#bpy.types.BlendImportContextLibrary)]
...
- [`BlendImportContext.import_items`](bpy.types.BlendImportContext.html#bpy.types.BlendImportContext.import_items)
