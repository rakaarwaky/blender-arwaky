...
How often rows are offset. A value of 2 gives an even/uneven pattern of rows. (in [1, 99], default 2)
...
Factor to adjust the brick’s width for particular rows determined by the Offset Frequency (in [0, 99], default 1.0)
