...
- `START` Start Frame – Sort channels by first frame number. 
- `END` End Frame – Sort channels by last frame number.   Type: 
...
- [`MovieTracking.dopesheet`](bpy.types.MovieTracking.html#bpy.types.MovieTracking.dopesheet)
