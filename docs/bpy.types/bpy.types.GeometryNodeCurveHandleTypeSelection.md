...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeCurveHandleTypeSelection(GeometryNode) 
...
- `ALIGN` Align – The location is constrained to point in the opposite direction as the other handle.   Type: 
...
set[Literal[[Node Geometry Curve Handle Side Items](bpy_types_enum_items/node_geometry_curve_handle_side_items.html#rna-enum-node-geometry-curve-handle-side-items)]]
