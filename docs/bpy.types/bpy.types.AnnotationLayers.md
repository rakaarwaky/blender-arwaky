...
- set_active (bool) – Set Active, Set the newly created layer to the active layer (optional)   Returns: 
...
layer ([`AnnotationLayer`](bpy.types.AnnotationLayer.html#bpy.types.AnnotationLayer) | None) – The layer to remove (never None)
