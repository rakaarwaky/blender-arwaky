...
[`XrUserPath`](bpy.types.XrUserPath.html#bpy.types.XrUserPath)
...
user_path ([`XrUserPath`](bpy.types.XrUserPath.html#bpy.types.XrUserPath) | None) – User Path, (never None)
