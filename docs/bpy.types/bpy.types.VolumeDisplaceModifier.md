# bpy.types.VolumeDisplaceModifier
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Modifier`](bpy.types.Modifier.html#bpy.types.Modifier)
   ...
   class bpy.types.VolumeDisplaceModifier(Modifier)   strength 
...
- `OBJECT` Object – Use the linked object’s local coordinate system for the texture coordinates.   Type: 
