...
- `RGB_TO_XYZ` RGB to XYZ – Use the texture’s RGB values to displace the mesh in the XYZ direction.   Type: 
...
- `GLOBAL` Global – Direction is defined in global coordinates.   Type: 
