...
- [`BlendData.shape_keys`](bpy.types.BlendData.html#bpy.types.BlendData.shape_keys) 
- [`Curve.shape_keys`](bpy.types.Curve.html#bpy.types.Curve.shape_keys)   
- [`Lattice.shape_keys`](bpy.types.Lattice.html#bpy.types.Lattice.shape_keys) 
- [`Mesh.shape_keys`](bpy.types.Mesh.html#bpy.types.Mesh.shape_keys)
