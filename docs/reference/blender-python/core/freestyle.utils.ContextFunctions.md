...
- sigma (float) – The sigma value of the gaussian function.       freestyle.utils.ContextFunctions.read_complete_view_map_pixel(level, x, y) 
...
- y (int) – The y coordinate of the pixel we wish to read. The origin is in the lower-left corner.   Returns: 
