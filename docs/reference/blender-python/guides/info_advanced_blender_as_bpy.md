...
The attribute [`bpy.app.binary_path`](bpy.app.html#bpy.app.binary_path) defaults to an empty string.
...
There are many modules included with Blender such as [`gpu`](gpu.html#module-gpu) and [`mathutils`](mathutils.html#module-mathutils). It’s important that these are imported after `bpy` or they will not be found.
...
The user’s startup and preferences are ignored to prevent your local configuration from impacting script behavior. The Python module behaves as if `--factory-startup` was passed as a command line argument.
...
- [`bpy.types.BlendDataLibraries.load()`](bpy.types.BlendDataLibraries.html#bpy.types.BlendDataLibraries.load) 
- [`bpy.types.BlendDataLibraries.write()`](bpy.types.BlendDataLibraries.html#bpy.types.BlendDataLibraries.write) 
- [`bpy.types.BlendData.temp_data()`](bpy.types.BlendData.html#bpy.types.BlendData.temp_data) supports a temporary data-context to avoid manipulating the current `.blend` file.
