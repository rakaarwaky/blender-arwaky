...
It is possible to define both `get`/`set` and `get_transform`/`set_transform` callbacks for the same property. In practice however, this should rarely be needed, as most ‘transform’ operation can also happen within a `get`/`set` callback.
...
- default (bool) – The default value for this property. 
- options (set[str]) – Enumerator in [Property Flag Items](bpy_types_enum_items/property_flag_items.html#rna-enum-property-flag-items). 
- override (set[str]) – Enumerator in [Property Override Flag Items](bpy_types_enum_items/property_override_flag_items.html#rna-enum-property-override-flag-items). 
- tags (set[str]) – Enumerator of tags that are defined by parent class. 
- subtype (str) – Enumerator in [Property Subtype Number Items](bpy_types_enum_items/property_subtype_number_items.html#rna-enum-property-subtype-number-items). 
- update (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context)], None] | None) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. Warning there are no safety checks to avoid infinite recursion. 
- get (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)], bool] | None) – 
...
- set (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), bool], None] | None) – 
...
- get_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), bool, bool], bool] | None) – 
...
- set_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), bool, bool, bool], bool] | None) – 
...
The callback is responsible to ensure that value limits (min/max, length…) are respected. Otherwise a ValueError exception is raised.   Returns: 

Opaque type used for registration.
...
- override (set[str]) – Enumerator in [Property Override Flag Items](bpy_types_enum_items/property_override_flag_items.html#rna-enum-property-override-flag-items). 
- tags (set[str]) – Enumerator of tags that are defined by parent class. 
- subtype (str) – Enumerator in [Property Subtype Number Array Items](bpy_types_enum_items/property_subtype_number_array_items.html#rna-enum-property-subtype-number-array-items). 
- size (int | Sequence[int]) – Vector dimensions in [1, 32]. An int sequence can be used to define multi-dimension arrays. 
- update (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context)], None] | None) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. Warning there are no safety checks to avoid infinite recursion. 
- get (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)], Sequence[bool]] | None) – 
...
Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set). 
- set (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), tuple[bool, …]], None] | None) – 
...
Defining this callback without a matching `get` one is invalid. 
- get_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), Sequence[bool], bool], Sequence[bool]] | None) – 
...
The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised. 
- set_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), Sequence[bool], Sequence[bool], bool], Sequence[bool]] | None) – 
...
Returns a new collection property definition.
  ...
  Parameters:  
- type (type[[`bpy.types.PropertyGroup`](bpy.types.PropertyGroup.html#bpy.types.PropertyGroup)]) – A subclass of a property group. 
- name (str) – Name used in the user interface. 
- description (str) – Text used for the tooltip and api documentation. 
- translation_context (str) – Text used as context to disambiguate translations. 
- options (set[str]) – Enumerator in [Property Flag Items](bpy_types_enum_items/property_flag_items.html#rna-enum-property-flag-items). 
- override (set[str]) – Enumerator in [Property Override Flag Collection Items](bpy_types_enum_items/property_override_flag_collection_items.html#rna-enum-property-override-flag-collection-items). 
- tags (set[str]) – Enumerator of tags that are defined by parent class.   Returns: 
...
Returns a new enumerator property definition.
  ...
  Parameters:  
- items (Iterable[tuple[str, str, str] | tuple[str, str, str, int] | tuple[str, str, str, str | int, int] | None] | Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context) | None], Iterable[tuple[str, str, str] | tuple[str, str, str, int] | tuple[str, str, str, str | int, int] | None]]) – 
...
An icon string identifier or integer icon value (e.g. returned by [`bpy.types.UILayout.icon`](bpy.types.UILayout.html#bpy.types.UILayout.icon))
...
- description (str) – Text used for the tooltip and api documentation. 
- translation_context (str) – Text used as context to disambiguate translations. 
- default (str | int | set[str] | None) – The default value for this enum, a string from the identifiers used in items, or integer matching an item number. If the ENUM_FLAG option is used this must be a set of such string identifiers instead. WARNING: Strings cannot be specified for dynamic enums (i.e. if a callback function is given as items parameter). 
- options (set[str]) – Enumerator in [Property Flag Enum Items](bpy_types_enum_items/property_flag_enum_items.html#rna-enum-property-flag-enum-items). 
- override (set[str]) – Enumerator in [Property Override Flag Items](bpy_types_enum_items/property_override_flag_items.html#rna-enum-property-override-flag-items). 
- tags (set[str]) – Enumerator of tags that are defined by parent class. 
- update (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context)], None] | None) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. Warning there are no safety checks to avoid infinite recursion. 
- get (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)], int] | None) – 
...
Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set). 
- set (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), int], None] | None) – 
...
Defining this callback without a matching `get` one is invalid. 
- get_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), int, bool], int] | None) – 
...
The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised. 
- set_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), int, int, bool], int] | None) – 
...
- description (str) – Text used for the tooltip and api documentation. 
- translation_context (str) – Text used as context to disambiguate translations. 
- default (float) – The default value for this property. 
...
- step (float) – Step of increment/decrement in UI, in [1, 100], defaults to 3 (WARNING: actual value is /100). 
...
- tags (set[str]) – Enumerator of tags that are defined by parent class. 
- subtype (str) – Enumerator in [Property Subtype Number Items](bpy_types_enum_items/property_subtype_number_items.html#rna-enum-property-subtype-number-items). 
- unit (str) – Enumerator in [Property Unit Items](bpy_types_enum_items/property_unit_items.html#rna-enum-property-unit-items). 
- update (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context)], None] | None) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. Warning there are no safety checks to avoid infinite recursion. 
- get (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)], float] | None) – 
...
Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set). 
- set (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), float], None] | None) – 
...
Defining this callback without a matching `get` one is invalid. 
- get_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), float, bool], float] | None) – 
...
The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised. 
- set_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), float, float, bool], float] | None) – 
...
- size (int | Sequence[int]) – Vector dimensions in [1, 32]. An int sequence can be used to define multi-dimension arrays. 
- update (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context)], None] | None) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. Warning there are no safety checks to avoid infinite recursion. 
- get (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)], Sequence[float]] | None) – 
...
Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set). 
- set (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), tuple[float, …]], None] | None) – 
...
Defining this callback without a matching `get` one is invalid. 
- get_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), Sequence[float], bool], Sequence[float]] | None) – 
...
The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised. 
- set_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), Sequence[float], Sequence[float], bool], Sequence[float]] | None) – 
...
- description (str) – Text used for the tooltip and api documentation. 
- translation_context (str) – Text used as context to disambiguate translations. 
- default (int) – The default value for this property. 
...
- size (int | Sequence[int]) – Vector dimensions in [1, 32]. An int sequence can be used to define multi-dimension arrays. 
- update (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context)], None] | None) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. Warning there are no safety checks to avoid infinite recursion. 
- get (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)], Sequence[int]] | None) – 
...
Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set). 
- set (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), tuple[int, …]], None] | None) – 
...
Defining this callback without a matching `get` one is invalid. 
- get_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), Sequence[int], bool], Sequence[int]] | None) – 
...
The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised. 
- set_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), Sequence[int], Sequence[int], bool], Sequence[int]] | None) – 
...
Returns a new pointer property definition.
  ...
  Parameters:  
- type (type[[`bpy.types.PropertyGroup`](bpy.types.PropertyGroup.html#bpy.types.PropertyGroup) | [`bpy.types.ID`](bpy.types.ID.html#bpy.types.ID)]) – A subclass of PropertyGroup or ID. 
- name (str) – Name used in the user interface. 
- description (str) – Text used for the tooltip and api documentation. 
- translation_context (str) – Text used as context to disambiguate translations. 
- options (set[str]) – Enumerator in [Property Flag Items](bpy_types_enum_items/property_flag_items.html#rna-enum-property-flag-items). 
- override (set[str]) – Enumerator in [Property Override Flag Items](bpy_types_enum_items/property_override_flag_items.html#rna-enum-property-override-flag-items). 
- tags (set[str]) – Enumerator of tags that are defined by parent class. 
- poll (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.ID`](bpy.types.ID.html#bpy.types.ID)], bool] | None) – 
...
- update (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context)], None] | None) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. Warning there are no safety checks to avoid infinite recursion.   Returns: 
...
Pointer properties do not support storing references to embedded IDs (e.g. [`bpy.types.Scene.collection`](bpy.types.Scene.html#bpy.types.Scene.collection), [`bpy.types.Material.node_tree`](bpy.types.Material.html#bpy.types.Material.node_tree)). These should exclusively be referenced and accessed through their owner ID (e.g. the scene or material).
...
Removes a dynamically defined property.
  ...
  Parameters:  
- cls (type[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)]) – The class containing the property (must be a positional argument). 
...
- override (set[str]) – Enumerator in [Property Override Flag Items](bpy_types_enum_items/property_override_flag_items.html#rna-enum-property-override-flag-items). 
- tags (set[str]) – Enumerator of tags that are defined by parent class. 
- subtype (str) – Enumerator in [Property Subtype String Items](bpy_types_enum_items/property_subtype_string_items.html#rna-enum-property-subtype-string-items). 
- update (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context)], None] | None) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. Warning there are no safety checks to avoid infinite recursion. 
- get (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)], str] | None) – 
...
Defining this callback without a matching `set` one will make the property read-only (even if `READ_ONLY` option is not set). 
- set (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), str], None] | None) – 
...
Defining this callback without a matching `get` one is invalid. 
- get_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), str, bool], str] | None) – 
...
The callback is responsible to ensure that value limits of the property (min/max, length…) are respected. Otherwise a ValueError exception is raised. 
- set_transform (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), str, str, bool], str] | None) – 
...
- search (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context), str], Iterable[str | tuple[str, str]]] | None) – 
...
- ’SUGGESTION’ lets the user enter values not found in search candidates. WARNING disabling this flag causes the search callback to run on redraw, so only disable this flag if it’s not likely to cause performance issues.   Returns: 
...
The property registration function (e.g. `bpy.props.IntProperty()`).
