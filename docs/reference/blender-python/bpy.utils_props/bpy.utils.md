...
- [bpy.utils submodule (bpy.utils.units)](bpy.utils.units.html)     bpy.utils.blend_paths(*, absolute=False, packed=False, local=False) 
...
- local (bool) – When true skip linked library paths.   Returns: 
...
- strip_digits (bool) – Whether to remove `.###` suffix.   Returns: 
...
cls (type[[`bpy.types.Panel`](bpy.types.Panel.html#bpy.types.Panel) | [`bpy.types.UIList`](bpy.types.UIList.html#bpy.types.UIList) | [`bpy.types.Menu`](bpy.types.Menu.html#bpy.types.Menu) | [`bpy.types.Header`](bpy.types.Header.html#bpy.types.Header) | [`bpy.types.Operator`](bpy.types.Operator.html#bpy.types.Operator) | [`bpy.types.KeyingSetInfo`](bpy.types.KeyingSetInfo.html#bpy.types.KeyingSetInfo) | [`bpy.types.RenderEngine`](bpy.types.RenderEngine.html#bpy.types.RenderEngine) | [`bpy.types.AssetShelf`](bpy.types.AssetShelf.html#bpy.types.AssetShelf) | [`bpy.types.FileHandler`](bpy.types.FileHandler.html#bpy.types.FileHandler) | [`bpy.types.PropertyGroup`](bpy.types.PropertyGroup.html#bpy.types.PropertyGroup) | [`bpy.types.AddonPreferences`](bpy.types.AddonPreferences.html#bpy.types.AddonPreferences) | [`bpy.types.NodeTree`](bpy.types.NodeTree.html#bpy.types.NodeTree) | [`bpy.types.Node`](bpy.types.Node.html#bpy.types.Node) | [`bpy.types.NodeSocket`](bpy.types.NodeSocket.html#bpy.types.NodeSocket) | [`bpy.types.Gizmo`](bpy.types.Gizmo.html#bpy.types.Gizmo) | [`bpy.types.GizmoGroup`](bpy.types.GizmoGroup.html#bpy.types.GizmoGroup)]) – Registerable Blender class type.
...
- execute (Callable[[list[str]], int]) – Callback, taking a single list of strings and returns an int. The arguments are built from all command-line arguments following the command id. The return value should be 0 for success, 1 on failure (specific error codes from the `os` module can also be used).   Returns: 
...
handle (Any) – The return value of `register_cli_command()`.
      ...
      bpy.utils.resource_path(type, *, major=None, minor=None) 

Return the base path for storing system files.

  Parameters:  
- type (Literal['USER', 'LOCAL', 'SYSTEM', 'SYSTEM_LIBS']) – The resource type. 
- major (int | None) – Major version. None (the default) uses `bpy.app.version[0]`. 
- minor (int | None) – Minor version. None (the default) uses `bpy.app.version[1]`.   Returns: 
...
cls (type[[`bpy.types.Panel`](bpy.types.Panel.html#bpy.types.Panel) | [`bpy.types.UIList`](bpy.types.UIList.html#bpy.types.UIList) | [`bpy.types.Menu`](bpy.types.Menu.html#bpy.types.Menu) | [`bpy.types.Header`](bpy.types.Header.html#bpy.types.Header) | [`bpy.types.Operator`](bpy.types.Operator.html#bpy.types.Operator) | [`bpy.types.KeyingSetInfo`](bpy.types.KeyingSetInfo.html#bpy.types.KeyingSetInfo) | [`bpy.types.RenderEngine`](bpy.types.RenderEngine.html#bpy.types.RenderEngine) | [`bpy.types.AssetShelf`](bpy.types.AssetShelf.html#bpy.types.AssetShelf) | [`bpy.types.FileHandler`](bpy.types.FileHandler.html#bpy.types.FileHandler) | [`bpy.types.PropertyGroup`](bpy.types.PropertyGroup.html#bpy.types.PropertyGroup) | [`bpy.types.AddonPreferences`](bpy.types.AddonPreferences.html#bpy.types.AddonPreferences) | [`bpy.types.NodeTree`](bpy.types.NodeTree.html#bpy.types.NodeTree) | [`bpy.types.Node`](bpy.types.Node.html#bpy.types.Node) | [`bpy.types.NodeSocket`](bpy.types.NodeSocket.html#bpy.types.NodeSocket) | [`bpy.types.Gizmo`](bpy.types.Gizmo.html#bpy.types.Gizmo) | [`bpy.types.GizmoGroup`](bpy.types.GizmoGroup.html#bpy.types.GizmoGroup)]) – Blender type class, see `bpy.utils.register_class()` for classes which can be registered.
...
Initialize and refresh key configurations, called from the Blender window manager on startup and refresh.
...
Load and activate a key configuration from a file.
  ...
  Parameters:  
- filepath (str) – The file path to the key configuration preset. 
- report (Callable[[set[str], str], None] | None) – An optional callable for reporting errors.       bpy.utils.load_scripts(*, reload_scripts=False, refresh_scripts=False, extensions=True) 
...
- extensions (bool) – Loads additional scripts (add-ons & app-templates).       bpy.utils.modules_from_path(path, loaded_modules) 

Load all modules in a path and return them as a list.

  Parameters:  
- path (str) – this path is scanned for scripts and packages. 
- loaded_modules (set[str]) – already loaded module names, files matching these names will be ignored.   Returns: 
...
- display_name (bool) – When True, search by display name instead of filename. 
- ext (str) – The file extension for the preset.   Returns: 
...
- fps_base (float | None) – Frames per second base, if not given the current scene is used.   Returns: 
...
manual_hook (Callable[[], tuple[str, list[tuple[str, str]]]]) – A callable that returns `(prefix, mapping)` where mapping is a sequence of `(pattern, url)` pairs.
...
- submodule_names (list[str]) – List of submodule names to load and unload.   Returns: 
...
Register a tool in the toolbar.
  ...
  Parameters:  
- tool_cls (type[[`bpy.types.WorkSpaceTool`](bpy.types.WorkSpaceTool.html#bpy.types.WorkSpaceTool)]) – A tool subclass. 
...
- group (bool) – When true, add a new nested group of tools.       bpy.utils.make_rna_paths(struct_name, prop_name, enum_name) 
...
- enum_name (str) – Name of a RNA enum identifier.   Returns: 

A triple of three “RNA paths” (most_complete_path, “struct.prop”, “struct.prop:’enum’”). If no enum_name is given, the third element will always be empty.
...
Iterator[tuple[str, list[tuple[str, str]]]]
      ...
      bpy.utils.manual_language_code(default='en')  Parameters: 

default (str) – The fallback language code to use when the current language is unavailable.
...
- create (bool) – Treat the path as a directory and create it if its not existing.   Returns: 
...
- use_system_environment (bool) – Include BLENDER_SYSTEM_SCRIPTS variable path   Returns: 
...
tool_cls (type[[`bpy.types.WorkSpaceTool`](bpy.types.WorkSpaceTool.html#bpy.types.WorkSpaceTool)]) – The tool class to unregister.
...
- mod (ModuleType | None) – Optional cached module, the result of a previous execution.   Returns: 
