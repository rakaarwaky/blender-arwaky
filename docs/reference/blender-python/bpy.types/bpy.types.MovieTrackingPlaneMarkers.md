# bpy.types.MovieTrackingPlaneMarkers
...
- exact (bool) – Exact, Get plane marker at exact frame number rather than get estimated marker (optional)   Returns: 

Plane marker for specified frame

  Return type: 

[`MovieTrackingPlaneMarker`](bpy.types.MovieTrackingPlaneMarker.html#bpy.types.MovieTrackingPlaneMarker)
