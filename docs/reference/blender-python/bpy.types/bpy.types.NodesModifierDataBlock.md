# bpy.types.NodesModifierDataBlock
...
base class — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)
   ...
   class bpy.types.NodesModifierDataBlock(bpy_struct)   id  Type: 
...
- [`NodesModifierBake.data_blocks`](bpy.types.NodesModifierBake.html#bpy.types.NodesModifierBake.data_blocks)
