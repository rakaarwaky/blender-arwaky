# bpy.types.LineStyleGeometryModifier_SpatialNoise
...
Number of octaves (i.e., the amount of detail of the spatial noise) (in [0, inf], default 0)
...
If true, the spatial noise does not show any coherence (default False)
