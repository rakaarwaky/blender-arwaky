...
Remove a font from the current blendfile
  ...
  Parameters:  
- vfont ([`VectorFont`](bpy.types.VectorFont.html#bpy.types.VectorFont) | None) – Font to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this font (optional)       tag(value) 
