...
- [`BlendData.fonts`](bpy.types.BlendData.html#bpy.types.BlendData.fonts) 
- [`BlendDataFonts.load`](bpy.types.BlendDataFonts.html#bpy.types.BlendDataFonts.load) 
- [`BlendDataFonts.remove`](bpy.types.BlendDataFonts.html#bpy.types.BlendDataFonts.remove) 
- [`GeometryNodeInputFont.font`](bpy.types.GeometryNodeInputFont.html#bpy.types.GeometryNodeInputFont.font) 
- [`NodeSocketFont.default_value`](bpy.types.NodeSocketFont.html#bpy.types.NodeSocketFont.default_value) 
- [`NodeTreeInterfaceSocketFont.default_value`](bpy.types.NodeTreeInterfaceSocketFont.html#bpy.types.NodeTreeInterfaceSocketFont.default_value)   
- [`TextCurve.font`](bpy.types.TextCurve.html#bpy.types.TextCurve.font) 
- [`TextCurve.font_bold`](bpy.types.TextCurve.html#bpy.types.TextCurve.font_bold) 
- [`TextCurve.font_bold_italic`](bpy.types.TextCurve.html#bpy.types.TextCurve.font_bold_italic) 
- [`TextCurve.font_italic`](bpy.types.TextCurve.html#bpy.types.TextCurve.font_italic) 
- [`TextStrip.font`](bpy.types.TextStrip.html#bpy.types.TextStrip.font)
