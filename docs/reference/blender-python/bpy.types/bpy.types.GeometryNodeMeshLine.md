# bpy.types.GeometryNodeMeshLine
...
- `TOTAL` Count – Specify the total number of vertices. 
- `RESOLUTION` Resolution – Specify the distance between vertices.   Type: 
...
- `OFFSET` Offset – Specify the offset from one vertex to the next. 
- `END_POINTS` End Points – Specify the line’s start and end points.   Type: 
