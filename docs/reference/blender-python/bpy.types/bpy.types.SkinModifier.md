...
Smooth complex geometry around branches (in [0, 1], default 0.0)
...
Avoid making unsymmetrical quads across the X axis (default True)
...
Avoid making unsymmetrical quads across the Y axis (default False)
...
Avoid making unsymmetrical quads across the Z axis (default False)
