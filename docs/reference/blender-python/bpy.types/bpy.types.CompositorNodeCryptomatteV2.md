...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`CryptomatteEntry`](bpy.types.CryptomatteEntry.html#bpy.types.CryptomatteEntry)]
...
- `CryptoAsset` Asset – Use Asset layer.   Type: 
...
- `IMAGE` Image – Use Cryptomatte passes from an image.   Type: 
