...
Literal[[Workspace Object Mode Items](bpy_types_enum_items/workspace_object_mode_items.html#rna-enum-workspace-object-mode-items)]
...
[`wmOwnerIDs`](bpy.types.wmOwnerIDs.html#bpy.types.wmOwnerIDs)[[`wmOwnerID`](bpy.types.wmOwnerID.html#bpy.types.wmOwnerID)]
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`Screen`](bpy.types.Screen.html#bpy.types.Screen)]
...
[`wmTools`](bpy.types.wmTools.html#bpy.types.wmTools)[[`WorkSpaceTool`](bpy.types.WorkSpaceTool.html#bpy.types.WorkSpaceTool)]
...
text (str | None | Callable[[[`Header`](bpy.types.Header.html#bpy.types.Header), [`Context`](bpy.types.Context.html#bpy.types.Context)], None]) – Status text to display, `None` to clear, or a callable to install as the status bar’s draw function.
...
- [`BlendData.workspaces`](bpy.types.BlendData.html#bpy.types.BlendData.workspaces) 
- [`Context.workspace`](bpy.types.Context.html#bpy.types.Context.workspace)   
- [`Window.workspace`](bpy.types.Window.html#bpy.types.Window.workspace)
