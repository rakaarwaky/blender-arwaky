...
[`NodeSeparateBundleItems`](bpy.types.NodeSeparateBundleItems.html#bpy.types.NodeSeparateBundleItems)[[`NodeSeparateBundleItem`](bpy.types.NodeSeparateBundleItem.html#bpy.types.NodeSeparateBundleItem)]

      define_signature 

This node defines a bundle signature that should be used by other nodes (default False)
