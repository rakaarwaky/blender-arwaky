...
- `SYSTEM` System – Read-only repository provided by the system.   Returns: 

Newly added repository

  Return type: 

[`UserExtensionRepo`](bpy.types.UserExtensionRepo.html#bpy.types.UserExtensionRepo)
...
repo ([`UserExtensionRepo`](bpy.types.UserExtensionRepo.html#bpy.types.UserExtensionRepo) | None) – Repository to remove (never None)
