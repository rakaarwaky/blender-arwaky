...
- [SpaceView3D(Space)](bpy.types.SpaceView3D.html)     class bpy.types.Space(bpy_struct) 
...
- [`Area.spaces`](bpy.types.Area.html#bpy.types.Area.spaces) 
- [`AreaSpaces.active`](bpy.types.AreaSpaces.html#bpy.types.AreaSpaces.active)   
- [`Context.space_data`](bpy.types.Context.html#bpy.types.Context.space_data)
