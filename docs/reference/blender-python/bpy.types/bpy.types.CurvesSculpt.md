...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Paint`](bpy.types.Paint.html#bpy.types.Paint)
   ...
   class bpy.types.CurvesSculpt(Paint)   classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
...
- [`ToolSettings.curves_sculpt`](bpy.types.ToolSettings.html#bpy.types.ToolSettings.curves_sculpt)
