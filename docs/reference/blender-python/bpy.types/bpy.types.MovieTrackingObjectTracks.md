...
[`MovieTrackingTrack`](bpy.types.MovieTrackingTrack.html#bpy.types.MovieTrackingTrack) | None
...
- frame (int) – Frame, Frame number to add tracks on (in [0, 1048574], optional)   Returns: 

Newly created track

  Return type: 

[`MovieTrackingTrack`](bpy.types.MovieTrackingTrack.html#bpy.types.MovieTrackingTrack)
