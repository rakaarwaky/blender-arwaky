...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Modifier`](bpy.types.Modifier.html#bpy.types.Modifier)
   ...
   class bpy.types.GreasePencilOpacityModifier(Modifier)   color_factor 
...
- `BOTH` Stroke & Fill – Modify fill and stroke colors. 
- `STROKE` Stroke – Modify stroke color only. 
- `FILL` Fill – Modify fill color only. 
- `HARDNESS` Hardness – Modify stroke hardness.   Type: 
