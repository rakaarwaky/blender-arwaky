...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`ShaderNode`](bpy.types.ShaderNode.html#bpy.types.ShaderNode)
   ...
   class bpy.types.ShaderNodeBsdfToon(ShaderNode) 

Diffuse and Glossy shaders with cartoon light effects

   component 

Toon BSDF component to use (default `'DIFFUSE'`)

  
- `DIFFUSE` Diffuse – Use diffuse BSDF. 
- `GLOSSY` Glossy – Use glossy BSDF.   Type: 

Literal[‘DIFFUSE’, ‘GLOSSY’]
