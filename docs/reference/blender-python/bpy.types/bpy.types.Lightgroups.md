...
[`Lightgroup`](bpy.types.Lightgroup.html#bpy.types.Lightgroup)
...
lightgroup ([`Lightgroup`](bpy.types.Lightgroup.html#bpy.types.Lightgroup) | None) – Lightgroup to remove (never None)
