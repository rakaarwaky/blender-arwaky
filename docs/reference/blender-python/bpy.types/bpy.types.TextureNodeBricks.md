...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`TextureNode`](bpy.types.TextureNode.html#bpy.types.TextureNode)

   class bpy.types.TextureNodeBricks(TextureNode)   offset 

Determines the brick offset of the various rows (in [0, 1], default 0.0)
...
Offset every N rows (in [2, 99], default 0)
...
Factor to adjust the brick’s width for particular rows determined by the Offset Frequency (in [0, 99], default 0.0)
...
Squash every N rows (in [2, 99], default 0)
...
- `TextureNode.poll` 
- [`TextureNode.bl_rna_get_subclass`](bpy.types.TextureNode.html#bpy.types.TextureNode.bl_rna_get_subclass) 
- [`TextureNode.bl_rna_get_subclass_py`](bpy.types.TextureNode.html#bpy.types.TextureNode.bl_rna_get_subclass_py)
