...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`Function`](bpy.types.Function.html#bpy.types.Function)]
...
[`StringProperty`](bpy.types.StringProperty.html#bpy.types.StringProperty) | None
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`Property`](bpy.types.Property.html#bpy.types.Property)]
...
- default (`bpy.types.Struct` | None) – The value to return when not found.   Returns: 
...
- [`BlenderRNA.structs`](bpy.types.BlenderRNA.html#bpy.types.BlenderRNA.structs) 
- [`CollectionProperty.fixed_type`](bpy.types.CollectionProperty.html#bpy.types.CollectionProperty.fixed_type) 
- [`PointerProperty.fixed_type`](bpy.types.PointerProperty.html#bpy.types.PointerProperty.fixed_type)   
