...
Method to use for scattering points (default `'DENSITY_RANDOM'`)

  
- `DENSITY_RANDOM` Random – Distribute points randomly inside of the volume. 
- `DENSITY_GRID` Grid – Distribute the points in a grid pattern inside of the volume.   Type: 
