...
slot ([`ActionSlot`](bpy.types.ActionSlot.html#bpy.types.ActionSlot) | None) – Action Slot, The slot that should be animated by this channelbag
...
channelbag ([`ActionChannelbag`](bpy.types.ActionChannelbag.html#bpy.types.ActionChannelbag) | None) – The channelbag to remove
