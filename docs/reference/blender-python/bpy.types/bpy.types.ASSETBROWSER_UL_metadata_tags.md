# bpy.types.ASSETBROWSER_UL_metadata_tags
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`UIList`](bpy.types.UIList.html#bpy.types.UIList)
   ...
   class bpy.types.ASSETBROWSER_UL_metadata_tags(UIList)   classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
