...
Remove a speaker from the current blendfile
  ...
  Parameters:  
- speaker ([`Speaker`](bpy.types.Speaker.html#bpy.types.Speaker) | None) – Speaker to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this speaker data (optional)       tag(value) 
...
- [`BlendData.speakers`](bpy.types.BlendData.html#bpy.types.BlendData.speakers)
