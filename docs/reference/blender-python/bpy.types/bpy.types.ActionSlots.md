...
- name (str) – Name, Name of the slot. This will be made unique within the Action among slots of the same type (never None)   Returns: 
...
action_slot ([`ActionSlot`](bpy.types.ActionSlot.html#bpy.types.ActionSlot) | None) – Action Slot, The slot to remove
