...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`UIList`](bpy.types.UIList.html#bpy.types.UIList)
   ...
   class bpy.types.VIEWLAYER_UL_aov(UIList)   static aov_icon(item)  Parameters: 

item ([`bpy.types.AOV`](bpy.types.AOV.html#bpy.types.AOV)) – AOV item to pick an icon for.

  Returns: 

Icon identifier for item’s AOV type.
