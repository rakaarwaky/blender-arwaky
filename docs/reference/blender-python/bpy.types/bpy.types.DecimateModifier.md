...
- `DISSOLVE` Planar – Dissolve geometry to form planar polygons.   Type: 
...
set[Literal[[Mesh Delimit Mode Items](bpy_types_enum_items/mesh_delimit_mode_items.html#rna-enum-mesh-delimit-mode-items)]]
