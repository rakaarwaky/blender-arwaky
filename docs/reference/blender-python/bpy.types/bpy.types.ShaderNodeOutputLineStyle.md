...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`ShaderNode`](bpy.types.ShaderNode.html#bpy.types.ShaderNode)
   ...
   class bpy.types.ShaderNodeOutputLineStyle(ShaderNode) 
...
True if this node is used as the active output (default False)
...
Which renderer and viewport shading types to use the shaders for (default `'ALL'`)
...
- `CYCLES` Cycles – Use shaders for Cycles renderer.   Type: 

Literal[‘ALL’, ‘EEVEE’, ‘CYCLES’]
