# bpy.types.FunctionNodeSeparateColor
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`FunctionNode`](bpy.types.FunctionNode.html#bpy.types.FunctionNode)
   ...
   class bpy.types.FunctionNodeSeparateColor(FunctionNode) 
...
Literal[[Node Combsep Color Items](bpy_types_enum_items/node_combsep_color_items.html#rna-enum-node-combsep-color-items)]
