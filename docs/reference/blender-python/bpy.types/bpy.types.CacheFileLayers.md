...
[`CacheFileLayer`](bpy.types.CacheFileLayer.html#bpy.types.CacheFileLayer) | None
...
filepath (str) – File path to the archive used as a layer (never None)
...
layer ([`CacheFileLayer`](bpy.types.CacheFileLayer.html#bpy.types.CacheFileLayer) | None) – Layer to remove (never None)
