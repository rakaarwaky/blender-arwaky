...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal)
   ...
   class bpy.types.NodeClosureOutput(NodeInternal)   active_input_index 
...
[`NodeClosureInputItems`](bpy.types.NodeClosureInputItems.html#bpy.types.NodeClosureInputItems)[[`NodeClosureInputItem`](bpy.types.NodeClosureInputItem.html#bpy.types.NodeClosureInputItem)]
...
[`NodeClosureOutputItems`](bpy.types.NodeClosureOutputItems.html#bpy.types.NodeClosureOutputItems)[[`NodeClosureOutputItem`](bpy.types.NodeClosureOutputItem.html#bpy.types.NodeClosureOutputItem)]
