# bpy.types.AssetLibraryCollection
...
- directory (str) – Directory, (optional, never None)   Returns: 

Newly added asset library

  Return type: 

[`UserAssetLibrary`](bpy.types.UserAssetLibrary.html#bpy.types.UserAssetLibrary)
...
library ([`UserAssetLibrary`](bpy.types.UserAssetLibrary.html#bpy.types.UserAssetLibrary) | None) – (never None)
...
- [`PreferencesFilePaths.asset_libraries`](bpy.types.PreferencesFilePaths.html#bpy.types.PreferencesFilePaths.asset_libraries)
