...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`Area`](bpy.types.Area.html#bpy.types.Area)]
...
- [`BlendData.screens`](bpy.types.BlendData.html#bpy.types.BlendData.screens) 
- [`Context.screen`](bpy.types.Context.html#bpy.types.Context.screen)   
- [`Window.screen`](bpy.types.Window.html#bpy.types.Window.screen) 
- [`WorkSpace.screens`](bpy.types.WorkSpace.html#bpy.types.WorkSpace.screens)
