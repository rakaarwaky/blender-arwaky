# bpy.types.GreasePencilTimeModifierSegment
...
- `PINGPONG` Ping Pong – Loop back and forth.   Type: 
...
- [`GreasePencilTimeModifier.segments`](bpy.types.GreasePencilTimeModifier.html#bpy.types.GreasePencilTimeModifier.segments)
