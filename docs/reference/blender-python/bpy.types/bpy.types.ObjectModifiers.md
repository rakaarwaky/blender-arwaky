...
[`Modifier`](bpy.types.Modifier.html#bpy.types.Modifier) | None
...
- type (Literal[[Object Modifier Type Items](bpy_types_enum_items/object_modifier_type_items.html#rna-enum-object-modifier-type-items)]) – Modifier type to add   Returns: 

Newly created modifier

  Return type: 

[`Modifier`](bpy.types.Modifier.html#bpy.types.Modifier)
...
modifier ([`Modifier`](bpy.types.Modifier.html#bpy.types.Modifier) | None) – Modifier to remove (never None)
