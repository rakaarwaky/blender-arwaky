...
Literal[[Volume Grid Data Type Items](bpy_types_enum_items/volume_grid_data_type_items.html#rna-enum-volume-grid-data-type-items)]
...
- [`Volume.grids`](bpy.types.Volume.html#bpy.types.Volume.grids)
