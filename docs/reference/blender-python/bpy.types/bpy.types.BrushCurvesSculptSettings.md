...
base class — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)
   ...
   class bpy.types.BrushCurvesSculptSettings(bpy_struct)   add_amount 
...
- `REMOVE` Remove – Remove curves whose root points are too close.   Type: 
...
- [`Brush.curves_sculpt_settings`](bpy.types.Brush.html#bpy.types.Brush.curves_sculpt_settings)
