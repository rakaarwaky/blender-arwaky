...
Clamp the factor to [0,1] range (default False)
...
Clamp the result to [0,1] range (default False)
...
- `UNIFORM` Uniform – Use a single factor for all components. 
- `NON_UNIFORM` Non-Uniform – Per component factor.   Type: 
