...
- `FIT_STROKE` Stroke Length – Scale the texture to fit the length of each stroke.   Type: 
...
- `STROKE_AND_FILL` Stroke & Fill – Manipulate both stroke and fill texture coordinates.   Type: 
