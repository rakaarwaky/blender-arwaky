...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeMenuSwitch(GeometryNode) 
...
[`NodeEnumItem`](bpy.types.NodeEnumItem.html#bpy.types.NodeEnumItem) | None
...
[`NodeMenuSwitchItems`](bpy.types.NodeMenuSwitchItems.html#bpy.types.NodeMenuSwitchItems)[[`NodeEnumItem`](bpy.types.NodeEnumItem.html#bpy.types.NodeEnumItem)]
