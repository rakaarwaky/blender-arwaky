...
Append a node group tree to the path
  ...
  Parameters:  
- node_tree ([`NodeTree`](bpy.types.NodeTree.html#bpy.types.NodeTree) | None) – Node Tree, Node tree to append to the node editor path 
- node ([`Node`](bpy.types.Node.html#bpy.types.Node) | None) – Node, Group node linking to this node tree (optional)       pop() 
...
- [`SpaceNodeEditor.path`](bpy.types.SpaceNodeEditor.html#bpy.types.SpaceNodeEditor.path)
