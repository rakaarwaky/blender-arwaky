...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`DriverTarget`](bpy.types.DriverTarget.html#bpy.types.DriverTarget)]
...
- `CONTEXT_PROP` Context Property – Use the value from some RNA property within the current evaluation context.   Type: 
...
- [`ChannelDriverVariables.new`](bpy.types.ChannelDriverVariables.html#bpy.types.ChannelDriverVariables.new) 
- [`ChannelDriverVariables.remove`](bpy.types.ChannelDriverVariables.html#bpy.types.ChannelDriverVariables.remove)   
- [`Driver.variables`](bpy.types.Driver.html#bpy.types.Driver.variables)
