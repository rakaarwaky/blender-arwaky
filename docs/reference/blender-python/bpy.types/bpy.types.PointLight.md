...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`ID`](bpy.types.ID.html#bpy.types.ID), [`Light`](bpy.types.Light.html#bpy.types.Light)
...
- [`Light.type`](bpy.types.Light.html#bpy.types.Light.type) 
- [`Light.use_temperature`](bpy.types.Light.html#bpy.types.Light.use_temperature) 
- [`Light.color`](bpy.types.Light.html#bpy.types.Light.color) 
- [`Light.temperature`](bpy.types.Light.html#bpy.types.Light.temperature) 
- [`Light.temperature_color`](bpy.types.Light.html#bpy.types.Light.temperature_color) 
- [`Light.specular_factor`](bpy.types.Light.html#bpy.types.Light.specular_factor) 
- [`Light.diffuse_factor`](bpy.types.Light.html#bpy.types.Light.diffuse_factor) 
- [`Light.transmission_factor`](bpy.types.Light.html#bpy.types.Light.transmission_factor) 
- [`Light.volume_factor`](bpy.types.Light.html#bpy.types.Light.volume_factor) 
- [`Light.use_custom_distance`](bpy.types.Light.html#bpy.types.Light.use_custom_distance) 
- [`Light.cutoff_distance`](bpy.types.Light.html#bpy.types.Light.cutoff_distance) 
- [`Light.use_shadow`](bpy.types.Light.html#bpy.types.Light.use_shadow) 
- [`Light.exposure`](bpy.types.Light.html#bpy.types.Light.exposure) 
- [`Light.normalize`](bpy.types.Light.html#bpy.types.Light.normalize) 
- [`Light.node_tree`](bpy.types.Light.html#bpy.types.Light.node_tree) 
- [`Light.use_nodes`](bpy.types.Light.html#bpy.types.Light.use_nodes) 
- [`Light.animation_data`](bpy.types.Light.html#bpy.types.Light.animation_data) 
- [`Light.cycles`](bpy.types.Light.html#bpy.types.Light.cycles)     
...
- [`Light.area`](bpy.types.Light.html#bpy.types.Light.area) 
- [`Light.inline_shader_nodes`](bpy.types.Light.html#bpy.types.Light.inline_shader_nodes) 
- [`Light.bl_rna_get_subclass`](bpy.types.Light.html#bpy.types.Light.bl_rna_get_subclass) 
- [`Light.bl_rna_get_subclass_py`](bpy.types.Light.html#bpy.types.Light.bl_rna_get_subclass_py)
