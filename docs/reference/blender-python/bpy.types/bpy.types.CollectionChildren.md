...
child ([`Collection`](bpy.types.Collection.html#bpy.types.Collection) | None) – Collection to add (never None)
...
child ([`Collection`](bpy.types.Collection.html#bpy.types.Collection) | None) – Collection to remove
...
- [`Collection.children`](bpy.types.Collection.html#bpy.types.Collection.children)
