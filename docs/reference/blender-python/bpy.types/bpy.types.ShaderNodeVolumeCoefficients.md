# bpy.types.ShaderNodeVolumeCoefficients
...
Phase function for the scattered light (default `'HENYEY_GREENSTEIN'`)
...
- `MIE` Mie – Approximation of Mie scattering in water droplets, used for scattering in clouds and fog.   Type: 
