...
[`StripModifier`](bpy.types.StripModifier.html#bpy.types.StripModifier) | None
...
- type (Literal[[Strip Modifier Type Items](bpy_types_enum_items/strip_modifier_type_items.html#rna-enum-strip-modifier-type-items)]) – Modifier type to add   Returns: 
...
modifier ([`StripModifier`](bpy.types.StripModifier.html#bpy.types.StripModifier) | None) – Modifier to remove (never None)
