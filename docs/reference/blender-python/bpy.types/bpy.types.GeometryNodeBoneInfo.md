# bpy.types.GeometryNodeBoneInfo

# GeometryNodeBoneInfo(GeometryNode)
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeBoneInfo(GeometryNode) 

Retrieve information of armature bones

   transform_space 

The transformation of the vector and geometry outputs (default `'ORIGINAL'`)

  
- `ORIGINAL` Original – Output the bone pose relative to the armature object transform. 
- `RELATIVE` Relative – Bring the bone pose into the modified object.   Type: 
