...
base class — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)
   ...
   class bpy.types.MaterialLineArt(bpy_struct)   intersection_priority 
...
- [`Material.lineart`](bpy.types.Material.html#bpy.types.Material.lineart)
