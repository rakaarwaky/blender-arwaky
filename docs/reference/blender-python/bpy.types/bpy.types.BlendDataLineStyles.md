...
Remove a line style instance from the current blendfile
  ...
  Parameters:  
- linestyle ([`FreestyleLineStyle`](bpy.types.FreestyleLineStyle.html#bpy.types.FreestyleLineStyle) | None) – Line style to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this line style (optional)       classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
