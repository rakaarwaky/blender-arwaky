...
- `ADD` Add – Add. 
- `SUBTRACT` Subtract – Subtract.       remove(index) 
...
- [`Object.vertex_groups`](bpy.types.Object.html#bpy.types.Object.vertex_groups) 
- [`VertexGroups.active`](bpy.types.VertexGroups.html#bpy.types.VertexGroups.active)   
- [`VertexGroups.new`](bpy.types.VertexGroups.html#bpy.types.VertexGroups.new) 
- [`VertexGroups.remove`](bpy.types.VertexGroups.html#bpy.types.VertexGroups.remove)
