...
[`UDIMTile`](bpy.types.UDIMTile.html#bpy.types.UDIMTile)
...
- label (str) – Optional label for the tile (optional, never None)   Returns: 
...
tile ([`UDIMTile`](bpy.types.UDIMTile.html#bpy.types.UDIMTile) | None) – Image tile to remove (never None)
