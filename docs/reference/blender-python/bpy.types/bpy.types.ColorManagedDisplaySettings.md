...
- `AUTO` Automatic – Display images consistent with most other applications, to preview images and video for export. A best effort is made to emulate the chosen display on the actual display device..   Type: 
...
- [`CompositorNodeConvertToDisplay.display_settings`](bpy.types.CompositorNodeConvertToDisplay.html#bpy.types.CompositorNodeConvertToDisplay.display_settings) 
- [`ImageFormatSettings.display_settings`](bpy.types.ImageFormatSettings.html#bpy.types.ImageFormatSettings.display_settings)   
- [`Scene.display_settings`](bpy.types.Scene.html#bpy.types.Scene.display_settings)
