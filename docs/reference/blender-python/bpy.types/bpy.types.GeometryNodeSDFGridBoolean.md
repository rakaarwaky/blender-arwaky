# bpy.types.GeometryNodeSDFGridBoolean
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeSDFGridBoolean(GeometryNode) 
...
- `INTERSECT` Intersect – Keep the part of the grids that is common between all operands. 
- `UNION` Union – Combine grids in an additive way. 
- `DIFFERENCE` Difference – Combine grids in a subtractive way.   Type: 
