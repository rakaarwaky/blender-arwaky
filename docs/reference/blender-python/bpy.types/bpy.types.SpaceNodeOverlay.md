...
- `3D` 3D – Use the material preview scene for the node previews.   Type: 
...
- [`SpaceNodeEditor.overlay`](bpy.types.SpaceNodeEditor.html#bpy.types.SpaceNodeEditor.overlay)
