...
[`Annotation`](bpy.types.Annotation.html#bpy.types.Annotation)
...
Remove annotation instance from the current blendfile
  ...
  Parameters:  
- annotation ([`Annotation`](bpy.types.Annotation.html#bpy.types.Annotation) | None) – Grease Pencil to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this annotation (optional)       classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
