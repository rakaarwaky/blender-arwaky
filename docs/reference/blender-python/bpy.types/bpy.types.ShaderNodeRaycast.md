...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`ShaderNode`](bpy.types.ShaderNode.html#bpy.types.ShaderNode)
   ...
   class bpy.types.ShaderNodeRaycast(ShaderNode) 
...
bool
      ...
      sample_attribute_items 

(default None, readonly)

  Type: 

[`NodeRaycastSampleAttributeItems`](bpy.types.NodeRaycastSampleAttributeItems.html#bpy.types.NodeRaycastSampleAttributeItems)[[`NodeRaycastSampleAttributeItem`](bpy.types.NodeRaycastSampleAttributeItem.html#bpy.types.NodeRaycastSampleAttributeItem)]
