...
[`Sound`](bpy.types.Sound.html#bpy.types.Sound)
...
Remove a sound from the current blendfile
  ...
  Parameters:  
- sound ([`Sound`](bpy.types.Sound.html#bpy.types.Sound) | None) – Sound to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this sound (optional)       tag(value) 
