# bpy.types.GeometryNodeMeshCone
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeMeshCone(GeometryNode) 
...
Literal[[Node Geometry Mesh Circle Fill Type Items](bpy_types_enum_items/node_geometry_mesh_circle_fill_type_items.html#rna-enum-node-geometry-mesh-circle-fill-type-items)]
