...
The delay of the effect in seconds (in [0.05, 5], default 0.0)
...
The feedback of the effect (in [0, 1], default 0.0)
...
The wet/dry mix of the effect (in [0, 1], default 0.0)
