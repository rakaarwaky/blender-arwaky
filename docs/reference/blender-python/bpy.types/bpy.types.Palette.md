...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`ID`](bpy.types.ID.html#bpy.types.ID)
   ...
   class bpy.types.Palette(ID)   colors 

(default None, readonly)

  Type: 

[`PaletteColors`](bpy.types.PaletteColors.html#bpy.types.PaletteColors)[[`PaletteColor`](bpy.types.PaletteColor.html#bpy.types.PaletteColor)]
...
- [`BlendData.palettes`](bpy.types.BlendData.html#bpy.types.BlendData.palettes) 
- [`BlendDataPalettes.new`](bpy.types.BlendDataPalettes.html#bpy.types.BlendDataPalettes.new)   
- [`BlendDataPalettes.remove`](bpy.types.BlendDataPalettes.html#bpy.types.BlendDataPalettes.remove) 
