# bpy.types.ThemeRegionsScrubbing
...
base class — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)
   ...
   class bpy.types.ThemeRegionsScrubbing(bpy_struct)   back 
...
- [`ThemeRegions.scrubbing`](bpy.types.ThemeRegions.html#bpy.types.ThemeRegions.scrubbing)
