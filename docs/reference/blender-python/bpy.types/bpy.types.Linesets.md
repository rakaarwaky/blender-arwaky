...
[`FreestyleLineSet`](bpy.types.FreestyleLineSet.html#bpy.types.FreestyleLineSet) | None
...
[`FreestyleLineSet`](bpy.types.FreestyleLineSet.html#bpy.types.FreestyleLineSet)
...
lineset ([`FreestyleLineSet`](bpy.types.FreestyleLineSet.html#bpy.types.FreestyleLineSet) | None) – Line set to remove (never None)
