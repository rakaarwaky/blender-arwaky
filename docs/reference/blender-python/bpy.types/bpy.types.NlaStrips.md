...
- action ([`Action`](bpy.types.Action.html#bpy.types.Action) | None) – Action to assign to this strip (never None)   Returns: 
...
strip ([`NlaStrip`](bpy.types.NlaStrip.html#bpy.types.NlaStrip) | None) – NLA Strip to remove (never None)
