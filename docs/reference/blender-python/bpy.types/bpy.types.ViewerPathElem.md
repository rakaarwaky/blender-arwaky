...
- [ViewerNodeViewerPathElem(ViewerPathElem)](bpy.types.ViewerNodeViewerPathElem.html)     class bpy.types.ViewerPathElem(bpy_struct) 
...
- [`ViewerPath.path`](bpy.types.ViewerPath.html#bpy.types.ViewerPath.path)
