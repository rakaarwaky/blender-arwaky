...
[`Spline`](bpy.types.Spline.html#bpy.types.Spline) | None
...
[`Spline`](bpy.types.Spline.html#bpy.types.Spline)
...
spline ([`Spline`](bpy.types.Spline.html#bpy.types.Spline) | None) – The spline to remove (never None)
