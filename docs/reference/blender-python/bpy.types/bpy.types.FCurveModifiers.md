...
[`FModifier`](bpy.types.FModifier.html#bpy.types.FModifier) | None
...
type (Literal[[Fmodifier Type Items](bpy_types_enum_items/fmodifier_type_items.html#rna-enum-fmodifier-type-items)]) – Constraint type to add
...
modifier ([`FModifier`](bpy.types.FModifier.html#bpy.types.FModifier) | None) – Removed modifier (never None)
