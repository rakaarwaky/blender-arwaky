...
[`NodeSocket`](bpy.types.NodeSocket.html#bpy.types.NodeSocket) | None
...
other (`NodeLink` | None) – Other, The other link. Must link to the same multi-input socket. (never None)
...
- [`NodeLinks.remove`](bpy.types.NodeLinks.html#bpy.types.NodeLinks.remove) 
