# bpy.types.GeometryNodeIndexSwitch
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeIndexSwitch(GeometryNode) 
...
[`NodeIndexSwitchItems`](bpy.types.NodeIndexSwitchItems.html#bpy.types.NodeIndexSwitchItems)[[`IndexSwitchItem`](bpy.types.IndexSwitchItem.html#bpy.types.IndexSwitchItem)]
