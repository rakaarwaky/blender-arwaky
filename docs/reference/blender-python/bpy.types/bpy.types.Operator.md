...
Such manual undo push is possible using the [`bpy.ops.ed.undo_push`](bpy.ops.ed.html#bpy.ops.ed.undo_push) function. Be careful though, this is considered an advanced feature and requires some understanding of the actual undo system in Blender code.
...
When an operator is called via [`bpy.ops`](bpy.ops.html#module-bpy.ops), the execution context depends on the argument provided to [`bpy.ops`](bpy.ops.html#module-bpy.ops). By default, it uses execute(). When an operator is activated from a button or menu item, it follows the setting in [`UILayout.operator_context`](bpy.types.UILayout.html#bpy.types.UILayout.operator_context). In most cases, invoke() is used. Running an operator via a key shortcut always uses invoke(), and this behavior cannot be changed.
...
This works like the [`Panel`](bpy.types.Panel.html#bpy.types.Panel) and [`Menu`](bpy.types.Menu.html#bpy.types.Menu) draw functions, its used for dialogs and file selectors.
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`Macro`](bpy.types.Macro.html#bpy.types.Macro)]
...
[`OperatorOptions`](bpy.types.OperatorOptions.html#bpy.types.OperatorOptions)
...
- message (str) – Report Message, (never None)       is_repeat() 
...
Compute a description string that depends on parameters
  ...
  Parameters:  
- context ([`Context`](bpy.types.Context.html#bpy.types.Context) | None) – (never None) 
- properties ([`OperatorProperties`](bpy.types.OperatorProperties.html#bpy.types.OperatorProperties) | None) – (never None)   Returns: 
...
str
      ...
      as_keywords(*, ignore=())  Parameters: 

ignore (Iterable[str]) – Property names to omit from the result.
...
- [`SpaceFileBrowser.active_operator`](bpy.types.SpaceFileBrowser.html#bpy.types.SpaceFileBrowser.active_operator) 
- [`SpaceFileBrowser.operator`](bpy.types.SpaceFileBrowser.html#bpy.types.SpaceFileBrowser.operator) 
- [`Window.modal_operators`](bpy.types.Window.html#bpy.types.Window.modal_operators) 
- [`WindowManager.fileselect_add`](bpy.types.WindowManager.html#bpy.types.WindowManager.fileselect_add) 
- [`WindowManager.invoke_confirm`](bpy.types.WindowManager.html#bpy.types.WindowManager.invoke_confirm)   
- [`WindowManager.invoke_popup`](bpy.types.WindowManager.html#bpy.types.WindowManager.invoke_popup) 
- [`WindowManager.invoke_props_dialog`](bpy.types.WindowManager.html#bpy.types.WindowManager.invoke_props_dialog) 
- [`WindowManager.invoke_props_popup`](bpy.types.WindowManager.html#bpy.types.WindowManager.invoke_props_popup) 
- [`WindowManager.invoke_search_popup`](bpy.types.WindowManager.html#bpy.types.WindowManager.invoke_search_popup) 
- [`WindowManager.modal_handler_add`](bpy.types.WindowManager.html#bpy.types.WindowManager.modal_handler_add) 
- [`WindowManager.operators`](bpy.types.WindowManager.html#bpy.types.WindowManager.operators)
