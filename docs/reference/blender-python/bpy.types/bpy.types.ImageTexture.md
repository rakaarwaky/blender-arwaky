...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`ID`](bpy.types.ID.html#bpy.types.ID), [`Texture`](bpy.types.Texture.html#bpy.types.Texture)
   ...
   class bpy.types.ImageTexture(Texture)   checker_distance 
...
- `CHECKER` Checker – Cause the image to repeat in checker board pattern.   Type: 
...
[`ImageUser`](bpy.types.ImageUser.html#bpy.types.ImageUser) | None
