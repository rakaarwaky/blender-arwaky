# bpy.types.FunctionNodeCompare

# FunctionNodeCompare(FunctionNode)

 

base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`FunctionNode`](bpy.types.FunctionNode.html#bpy.types.FunctionNode)

   class bpy.types.FunctionNodeCompare(FunctionNode) 
...
- `ELEMENT` Element-Wise – Compare each element of the input vectors. 
- `LENGTH` Length – Compare the length of the input vectors. 
- `AVERAGE` Average – Compare the average of the input vectors elements. 
- `DOT_PRODUCT` Dot Product – Compare the dot products of the input vectors. 
- `DIRECTION` Direction – Compare the direction of the input vectors.   Type: 
...
Literal[[Node Compare Operation Items](bpy_types_enum_items/node_compare_operation_items.html#rna-enum-node-compare-operation-items)]
...
- [`FunctionNode.bl_rna_get_subclass`](bpy.types.FunctionNode.html#bpy.types.FunctionNode.bl_rna_get_subclass) 
- [`FunctionNode.bl_rna_get_subclass_py`](bpy.types.FunctionNode.html#bpy.types.FunctionNode.bl_rna_get_subclass_py)
