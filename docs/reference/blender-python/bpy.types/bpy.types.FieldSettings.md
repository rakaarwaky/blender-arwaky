...
- `POINTS` Every Point – Field originates from all of the vertices of the object.   Type: 
...
- `WIND` Wind – Constant force along the force object’s local Z axis.   Type: 
...
- [`Object.field`](bpy.types.Object.html#bpy.types.Object.field) 
- [`ParticleSettings.force_field_1`](bpy.types.ParticleSettings.html#bpy.types.ParticleSettings.force_field_1)   
- [`ParticleSettings.force_field_2`](bpy.types.ParticleSettings.html#bpy.types.ParticleSettings.force_field_2)
