# bpy.types.FunctionNodeAxesToRotation
...
Axis that is aligned exactly to the provided primary direction (default `'X'`)
...
Axis that is aligned as well as possible given the alignment of the primary axis (default `'X'`)
