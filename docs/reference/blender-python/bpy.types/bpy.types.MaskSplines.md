...
[`MaskSpline`](bpy.types.MaskSpline.html#bpy.types.MaskSpline) | None
...
[`MaskSplinePoint`](bpy.types.MaskSplinePoint.html#bpy.types.MaskSplinePoint) | None
...
[`MaskSpline`](bpy.types.MaskSpline.html#bpy.types.MaskSpline)
...
spline ([`MaskSpline`](bpy.types.MaskSpline.html#bpy.types.MaskSpline) | None) – The spline to remove (never None)
