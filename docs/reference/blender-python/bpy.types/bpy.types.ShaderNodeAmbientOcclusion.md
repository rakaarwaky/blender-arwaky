...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`ShaderNode`](bpy.types.ShaderNode.html#bpy.types.ShaderNode)
   ...
   class bpy.types.ShaderNodeAmbientOcclusion(ShaderNode) 
...
Trace rays towards the inside of the object (default False)
...
Only consider the object itself when computing AO (default False)
...
Number of rays to trace per shader evaluation (in [1, 128], default 0)
