...
- `VARIABLE` Variable – Use variable bit quantization.   Type: 
...
- `WORLD` World – Specify volume step size and density in world space.   Type: 
...
- [`Volume.render`](bpy.types.Volume.html#bpy.types.Volume.render)
