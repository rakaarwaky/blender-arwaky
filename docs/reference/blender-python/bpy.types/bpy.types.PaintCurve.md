...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`ID`](bpy.types.ID.html#bpy.types.ID)
   ...
   class bpy.types.PaintCurve(ID)   classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
...
- [`BlendData.paint_curves`](bpy.types.BlendData.html#bpy.types.BlendData.paint_curves)   
- [`Brush.paint_curve`](bpy.types.Brush.html#bpy.types.Brush.paint_curve)
