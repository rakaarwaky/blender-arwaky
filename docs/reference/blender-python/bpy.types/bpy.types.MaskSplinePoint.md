...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`MaskSplinePointUW`](bpy.types.MaskSplinePointUW.html#bpy.types.MaskSplinePointUW)]
...
[`MaskParent`](bpy.types.MaskParent.html#bpy.types.MaskParent) | None
...
- [`MaskSpline.points`](bpy.types.MaskSpline.html#bpy.types.MaskSpline.points) 
- [`MaskSplinePoints.remove`](bpy.types.MaskSplinePoints.html#bpy.types.MaskSplinePoints.remove)   
- [`MaskSplines.active_point`](bpy.types.MaskSplines.html#bpy.types.MaskSplines.active_point)
