...
[`BlendImportContextItems`](bpy.types.BlendImportContextItems.html#bpy.types.BlendImportContextItems)[[`BlendImportContextItem`](bpy.types.BlendImportContextItem.html#bpy.types.BlendImportContextItem)]
...
- `COLLECTION_INSTANCE` Instantiate collections as empties, instead of linking them into the current view layer.   Type: 
...
- `DONE` All data has been imported and is available in the list of “import_items”.   Type: 
