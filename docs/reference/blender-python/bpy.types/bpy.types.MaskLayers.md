...
[`MaskLayer`](bpy.types.MaskLayer.html#bpy.types.MaskLayer) | None
...
[`MaskLayer`](bpy.types.MaskLayer.html#bpy.types.MaskLayer)
...
layer ([`MaskLayer`](bpy.types.MaskLayer.html#bpy.types.MaskLayer) | None) – Shape to be removed (never None)
