...
- [LightProbeVolume(LightProbe)](bpy.types.LightProbeVolume.html)     class bpy.types.LightProbe(ID) 
...
- `VOLUME` Volume – Light probe that captures low frequency lighting inside a volume.   Type: 
...
- [`BlendDataProbes.new`](bpy.types.BlendDataProbes.html#bpy.types.BlendDataProbes.new) 
- [`BlendDataProbes.remove`](bpy.types.BlendDataProbes.html#bpy.types.BlendDataProbes.remove)
