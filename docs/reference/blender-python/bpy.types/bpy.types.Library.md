...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[`Library`]
...
tuple[[`ID`](bpy.types.ID.html#bpy.types.ID), …]
...
Takes `O(n)` time, where `n` is the total number of all linkable ID types in `bpy.data`.
...
- [`BlendDataLibraries.remove`](bpy.types.BlendDataLibraries.html#bpy.types.BlendDataLibraries.remove) 
- [`BlendImportContextItem.source_library`](bpy.types.BlendImportContextItem.html#bpy.types.BlendImportContextItem.source_library) 
- [`ID.library`](bpy.types.ID.html#bpy.types.ID.library)   
