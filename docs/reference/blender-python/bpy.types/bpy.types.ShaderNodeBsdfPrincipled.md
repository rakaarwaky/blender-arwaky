...
Light scattering distribution on rough surface (default `'GGX'`)
...
- `RANDOM_WALK_LEGACY` Random Walk (Legacy) – Volumetric approximation to physically based volume scattering, using the scattering radius as specified.   Type: 
