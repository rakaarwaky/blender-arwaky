...
Remove an armature from the current blendfile
  ...
  Parameters:  
- armature ([`Armature`](bpy.types.Armature.html#bpy.types.Armature) | None) – Armature to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this armature data (optional)       tag(value) 
