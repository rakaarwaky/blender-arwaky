...
- y (float) – Y Position, Y Position for new point (in [-inf, inf])   Returns: 
...
point ([`CurveProfilePoint`](bpy.types.CurveProfilePoint.html#bpy.types.CurveProfilePoint) | None) – Point to remove (never None)
