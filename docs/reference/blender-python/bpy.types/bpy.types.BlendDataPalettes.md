...
[`Palette`](bpy.types.Palette.html#bpy.types.Palette)
...
Remove a palette from the current blendfile
  ...
  Parameters:  
- palette ([`Palette`](bpy.types.Palette.html#bpy.types.Palette) | None) – Palette to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this palette (optional)       tag(value) 
