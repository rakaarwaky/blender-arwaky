# bpy.types.FluidEffectorSettings
...
- `GUIDE` Guide – Create guide object.   Type: 
...
- `AVERAGED` Averaged – Take average of velocities from previous frame and new velocities from current frame.   Type: 
...
- [`FluidModifier.effector_settings`](bpy.types.FluidModifier.html#bpy.types.FluidModifier.effector_settings)
