...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Paint`](bpy.types.Paint.html#bpy.types.Paint)
   ...
   class bpy.types.GpWeightPaint(Paint)   classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
...
- [`ToolSettings.gpencil_weight_paint`](bpy.types.ToolSettings.html#bpy.types.ToolSettings.gpencil_weight_paint)
