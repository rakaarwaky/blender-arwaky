...
[`MetaBallElements`](bpy.types.MetaBallElements.html#bpy.types.MetaBallElements)[[`MetaElement`](bpy.types.MetaElement.html#bpy.types.MetaElement)]
...
- `NEVER` Never – While editing, don’t update metaball at all.   Type: 
...
- [`BlendData.metaballs`](bpy.types.BlendData.html#bpy.types.BlendData.metaballs)   
- [`BlendDataMetaBalls.new`](bpy.types.BlendDataMetaBalls.html#bpy.types.BlendDataMetaBalls.new) 
- [`BlendDataMetaBalls.remove`](bpy.types.BlendDataMetaBalls.html#bpy.types.BlendDataMetaBalls.remove)
