...
- object_data ([`ID`](bpy.types.ID.html#bpy.types.ID) | None) – Object data or None for an empty object   Returns: 
...
Remove an object from the current blendfile
  ...
  Parameters:  
- object ([`Object`](bpy.types.Object.html#bpy.types.Object) | None) – Object to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this object (optional)       tag(value) 
