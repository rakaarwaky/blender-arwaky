# bpy.types.FunctionNodeRotateRotation
...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`FunctionNode`](bpy.types.FunctionNode.html#bpy.types.FunctionNode)
   ...
   class bpy.types.FunctionNodeRotateRotation(FunctionNode) 

Apply a secondary rotation to a given rotation value

   rotation_space 

Base orientation for the rotation (default `'GLOBAL'`)

  
- `GLOBAL` Global – Rotate the input rotation in global space. 
