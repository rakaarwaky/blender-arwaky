...
Remove a scene from the current blendfile
  ...
  Parameters:  
- scene ([`Scene`](bpy.types.Scene.html#bpy.types.Scene) | None) – Scene to remove (never None) 
- do_unlink (bool) – Unlink all usages of this scene before deleting it (optional)       tag(value) 
