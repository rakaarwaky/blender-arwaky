...
base class — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)
   ...
   class bpy.types.ThemeSpaceGradient(bpy_struct)   gradients 

(readonly, never None)

  Type: 

[`ThemeGradientColors`](bpy.types.ThemeGradientColors.html#bpy.types.ThemeGradientColors)
...
- [`ThemeView3D.space`](bpy.types.ThemeView3D.html#bpy.types.ThemeView3D.space)
