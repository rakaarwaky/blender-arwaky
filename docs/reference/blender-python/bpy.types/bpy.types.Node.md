...
- [NodeInternal(Node)](bpy.types.NodeInternal.html)     class bpy.types.Node(bpy_struct) 
...
[`NodeInputs`](bpy.types.NodeInputs.html#bpy.types.NodeInputs)[[`NodeSocket`](bpy.types.NodeSocket.html#bpy.types.NodeSocket)]
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`NodeLink`](bpy.types.NodeLink.html#bpy.types.NodeLink)]
...
[`NodeOutputs`](bpy.types.NodeOutputs.html#bpy.types.NodeOutputs)[[`NodeSocket`](bpy.types.NodeSocket.html#bpy.types.NodeSocket)]
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`NodePanelState`](bpy.types.NodePanelState.html#bpy.types.NodePanelState)]
...
- `NONE` None – Do not propagate any messages upstream.   Type: 
...
link ([`NodeLink`](bpy.types.NodeLink.html#bpy.types.NodeLink) | None) – Link, Node link that will be inserted (never None)
...
node (`Node` | None) – Node, Existing node to copy (never None)
...
Draw node buttons in the sidebar
  ...
  Parameters:  
- context ([`Context`](bpy.types.Context.html#bpy.types.Context) | None) – (never None) 
- layout ([`UILayout`](bpy.types.UILayout.html#bpy.types.UILayout) | None) – Layout, Layout in the UI (never None)       draw_label() 
...
- [`GeometryNodeForeachGeometryElementInput.paired_output`](bpy.types.GeometryNodeForeachGeometryElementInput.html#bpy.types.GeometryNodeForeachGeometryElementInput.paired_output) 
- [`GeometryNodeMenuSwitch.enum_definition`](bpy.types.GeometryNodeMenuSwitch.html#bpy.types.GeometryNodeMenuSwitch.enum_definition) 
- [`GeometryNodeRepeatInput.paired_output`](bpy.types.GeometryNodeRepeatInput.html#bpy.types.GeometryNodeRepeatInput.paired_output) 
- [`GeometryNodeSimulationInput.paired_output`](bpy.types.GeometryNodeSimulationInput.html#bpy.types.GeometryNodeSimulationInput.paired_output) 
- `Node.copy` 
- `Node.parent` 
- [`NodeClosureInput.paired_output`](bpy.types.NodeClosureInput.html#bpy.types.NodeClosureInput.paired_output) 
- [`NodeLink.from_node`](bpy.types.NodeLink.html#bpy.types.NodeLink.from_node) 
- [`NodeLink.to_node`](bpy.types.NodeLink.html#bpy.types.NodeLink.to_node) 
...
- [`NodeTree.nodes`](bpy.types.NodeTree.html#bpy.types.NodeTree.nodes) 
...
- [`Nodes.active`](bpy.types.Nodes.html#bpy.types.Nodes.active) 
- [`Nodes.new`](bpy.types.Nodes.html#bpy.types.Nodes.new) 
- [`Nodes.remove`](bpy.types.Nodes.html#bpy.types.Nodes.remove) 
- [`NodesModifierBake.node`](bpy.types.NodesModifierBake.html#bpy.types.NodesModifierBake.node) 
...
- [`UILayout.template_node_inputs`](bpy.types.UILayout.html#bpy.types.UILayout.template_node_inputs) 
