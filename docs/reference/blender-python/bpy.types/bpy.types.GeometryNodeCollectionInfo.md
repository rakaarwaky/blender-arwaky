...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeCollectionInfo(GeometryNode) 

Retrieve geometry instances from a collection

   transform_space 

The transformation of the instances output. Does not affect the internal geometry (default `'ORIGINAL'`)

  
- `ORIGINAL` Original – Output the geometry relative to the collection offset. 
- `RELATIVE` Relative – Bring the input collection geometry into the modified object, maintaining the relative position between the objects in the scene.   Type: 

Literal[‘ORIGINAL’, ‘RELATIVE’]
