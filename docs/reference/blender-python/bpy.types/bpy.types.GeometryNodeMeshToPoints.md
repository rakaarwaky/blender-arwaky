# bpy.types.GeometryNodeMeshToPoints
...
- `VERTICES` Vertices – Create a point in the point cloud for each selected vertex. 
- `EDGES` Edges – Create a point in the point cloud for each selected edge. 
- `FACES` Faces – Create a point in the point cloud for each selected face. 
- `CORNERS` Corners – Create a point in the point cloud for each selected face corner.   Type: 
