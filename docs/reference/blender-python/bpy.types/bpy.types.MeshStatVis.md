...
base class — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)
   ...
   class bpy.types.MeshStatVis(bpy_struct)   distort_max 
...
- [`ToolSettings.statvis`](bpy.types.ToolSettings.html#bpy.types.ToolSettings.statvis)
