...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode)
   ...
   class bpy.types.GeometryNodeToolSetSelection(GeometryNode) 
...
Literal[[Attribute Domain Point Edge Face Curve Items](bpy_types_enum_items/attribute_domain_point_edge_face_curve_items.html#rna-enum-attribute-domain-point-edge-face-curve-items)]
...
- `BOOLEAN` Boolean – Store true or false selection values in edit mode. 
- `FLOAT` Float – Store floating point selection values. For mesh geometry, stored inverted as the sculpt mode mask.   Type: 

Literal[‘BOOLEAN’, ‘FLOAT’]
