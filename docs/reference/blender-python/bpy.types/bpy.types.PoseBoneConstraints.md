...
type (Literal[[Constraint Type Items](bpy_types_enum_items/constraint_type_items.html#rna-enum-constraint-type-items)]) – Constraint type to add
...
constraint ([`Constraint`](bpy.types.Constraint.html#bpy.types.Constraint) | None) – Removed constraint (never None)
...
- to_index (int) – To Index, Target index (in [-inf, inf])       copy(constraint) 

Add a new constraint that is a copy of the given one

  Parameters: 

constraint ([`Constraint`](bpy.types.Constraint.html#bpy.types.Constraint) | None) – Constraint to copy - may belong to a different object (never None)
