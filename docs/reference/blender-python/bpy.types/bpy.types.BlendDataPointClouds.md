...
Remove a point cloud from the current blendfile
  ...
  Parameters:  
- pointcloud ([`PointCloud`](bpy.types.PointCloud.html#bpy.types.PointCloud) | None) – Point cloud to remove (never None) 
...
- do_ui_user (bool) – Make sure interface does not reference this point cloud data (optional)       tag(value) 
