...
[`ClothSolverResult`](bpy.types.ClothSolverResult.html#bpy.types.ClothSolverResult) | None
...
- `bpy.context.cloth`   
- [`ParticleSystem.cloth`](bpy.types.ParticleSystem.html#bpy.types.ParticleSystem.cloth)
