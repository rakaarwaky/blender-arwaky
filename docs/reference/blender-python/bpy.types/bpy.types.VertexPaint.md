...
Restrict painting to vertices in the group (default False)
...
- [`ToolSettings.vertex_paint`](bpy.types.ToolSettings.html#bpy.types.ToolSettings.vertex_paint)   
- [`ToolSettings.weight_paint`](bpy.types.ToolSettings.html#bpy.types.ToolSettings.weight_paint)
