...
[`SceneRenderView`](bpy.types.SceneRenderView.html#bpy.types.SceneRenderView)
...
view ([`SceneRenderView`](bpy.types.SceneRenderView.html#bpy.types.SceneRenderView) | None) – Render view to remove (never None)
