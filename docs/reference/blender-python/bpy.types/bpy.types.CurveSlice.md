...
The index of this curve’s first control point (in [0, inf], default 0, readonly)
...
Number of control points in the curve (in [0, inf], default 0, readonly)
...
- [`Curves.curves`](bpy.types.Curves.html#bpy.types.Curves.curves)
