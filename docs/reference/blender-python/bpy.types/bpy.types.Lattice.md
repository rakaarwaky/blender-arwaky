...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`LatticePoint`](bpy.types.LatticePoint.html#bpy.types.LatticePoint)]
...
- shape_keys (bool) – Transform Shape Keys (optional)       update_gpu_tag() 
...
unit_test_compare
  ...
  Parameters:  
- lattice (`Lattice` | None) – Lattice to compare to (optional) 
...
- `bpy.context.lattice` 
- [`BlendData.lattices`](bpy.types.BlendData.html#bpy.types.BlendData.lattices) 
- [`BlendDataLattices.new`](bpy.types.BlendDataLattices.html#bpy.types.BlendDataLattices.new)   
- [`BlendDataLattices.remove`](bpy.types.BlendDataLattices.html#bpy.types.BlendDataLattices.remove) 
