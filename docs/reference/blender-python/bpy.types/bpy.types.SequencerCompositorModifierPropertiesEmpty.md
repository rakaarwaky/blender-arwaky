# bpy.types.SequencerCompositorModifierPropertiesEmpty
...
base class — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct)
   ...
   class bpy.types.SequencerCompositorModifierPropertiesEmpty(bpy_struct)   bl_system_properties_get(*, do_create=False) 
