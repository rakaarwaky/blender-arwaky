...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)[[`BoidRule`](bpy.types.BoidRule.html#bpy.types.BoidRule)]
...
- `AVERAGE` Average – All rules are averaged.   Type: 
...
- [`BoidSettings.states`](bpy.types.BoidSettings.html#bpy.types.BoidSettings.states)
