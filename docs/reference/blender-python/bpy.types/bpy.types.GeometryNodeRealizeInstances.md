...
Propagate instance attributes to the point domain rather than the curve domain. This property exists for compatibility with 5.0 and earlier. (default False)
