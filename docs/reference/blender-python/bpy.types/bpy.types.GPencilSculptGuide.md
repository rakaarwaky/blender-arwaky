...
- `OBJECT` Object – Use object as reference point.   Type: 
...
- `ISO` Isometric – Grid allows isometric and vertical lines.   Type: 
...
- [`GPencilSculptSettings.guide`](bpy.types.GPencilSculptSettings.html#bpy.types.GPencilSculptSettings.guide)
