# bpy.types.ChannelDriverVariables
...
[`DriverVariable`](bpy.types.DriverVariable.html#bpy.types.DriverVariable)
...
variable ([`DriverVariable`](bpy.types.DriverVariable.html#bpy.types.DriverVariable) | None) – Variable to remove from the driver (never None)
