...
- `VR_REDRAWS` VR Redraws – The gizmos are made for use with virtual reality sessions and require special redraw management.   Type: 
...
[`Gizmos`](bpy.types.Gizmos.html#bpy.types.Gizmos)[[`Gizmo`](bpy.types.Gizmo.html#bpy.types.Gizmo)]
...
keyconfig ([`KeyConfig`](bpy.types.KeyConfig.html#bpy.types.KeyConfig) | None) – (never None)
...
Run before invoke
  ...
  Parameters:  
- context ([`Context`](bpy.types.Context.html#bpy.types.Context) | None) – (never None) 
- gizmo ([`Gizmo`](bpy.types.Gizmo.html#bpy.types.Gizmo) | None) – (never None)       classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
...
- [`Context.gizmo_group`](bpy.types.Context.html#bpy.types.Context.gizmo_group)   
- [`Gizmo.group`](bpy.types.Gizmo.html#bpy.types.Gizmo.group)
