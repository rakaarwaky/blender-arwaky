...
- active (bool) – Active, (optional)   Returns: 

The newly created frame

  Return type: 

[`AnnotationFrame`](bpy.types.AnnotationFrame.html#bpy.types.AnnotationFrame)
...
frame ([`AnnotationFrame`](bpy.types.AnnotationFrame.html#bpy.types.AnnotationFrame) | None) – Frame, The frame to remove (never None)
...
source ([`AnnotationFrame`](bpy.types.AnnotationFrame.html#bpy.types.AnnotationFrame) | None) – Source, The source frame (never None)
