...
- `DIAGONAL` Diagonal – Bands across diagonal axis.   Type: 
...
- `SPHERICAL` Spherical – Rings along spherical distance.   Type: 
...
- `TRI` Triangle – Use a triangle profile.   Type: 
...
- `RINGS` Rings – Use wave texture in rings.   Type: 
