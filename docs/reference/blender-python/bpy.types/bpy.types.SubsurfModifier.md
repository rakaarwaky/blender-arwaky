...
- `OBJECT` Object – Subdivide to reach a specified edge length in object space. This is required to use adaptive subdivision for instanced meshes.   Type: 
...
Literal[[Subdivision Boundary Smooth Items](bpy_types_enum_items/subdivision_boundary_smooth_items.html#rna-enum-subdivision-boundary-smooth-items)]
...
- `SIMPLE` Simple – Subdivide faces without changing shape.   Type: 
...
Literal[[Subdivision Uv Smooth Items](bpy_types_enum_items/subdivision_uv_smooth_items.html#rna-enum-subdivision-uv-smooth-items)]
