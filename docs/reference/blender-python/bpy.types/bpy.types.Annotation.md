...
[`AnnotationLayers`](bpy.types.AnnotationLayers.html#bpy.types.AnnotationLayers)[[`AnnotationLayer`](bpy.types.AnnotationLayer.html#bpy.types.AnnotationLayer)]
...
- [`BlendData.annotations`](bpy.types.BlendData.html#bpy.types.BlendData.annotations) 
- [`BlendDataAnnotations.new`](bpy.types.BlendDataAnnotations.html#bpy.types.BlendDataAnnotations.new) 
- [`BlendDataAnnotations.remove`](bpy.types.BlendDataAnnotations.html#bpy.types.BlendDataAnnotations.remove) 
- [`MovieClip.annotation`](bpy.types.MovieClip.html#bpy.types.MovieClip.annotation) 
- [`MovieTrackingTrack.annotation`](bpy.types.MovieTrackingTrack.html#bpy.types.MovieTrackingTrack.annotation)   
- [`NodeTree.annotation`](bpy.types.NodeTree.html#bpy.types.NodeTree.annotation) 
- [`Scene.annotation`](bpy.types.Scene.html#bpy.types.Scene.annotation) 
- [`SpaceImageEditor.annotation`](bpy.types.SpaceImageEditor.html#bpy.types.SpaceImageEditor.annotation) 
- [`SpaceSequenceEditor.annotation`](bpy.types.SpaceSequenceEditor.html#bpy.types.SpaceSequenceEditor.annotation)
