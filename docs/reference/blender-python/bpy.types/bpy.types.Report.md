...
Literal[[Wm Report Items](bpy_types_enum_items/wm_report_items.html#rna-enum-wm-report-items)]
...
- [`WindowManager.reports`](bpy.types.WindowManager.html#bpy.types.WindowManager.reports)
