...
- `FINE` Fine – Display box for each leaf node containing 8×8 voxels.   Type: 
...
- `POINTS` Points – Display points for nodes in the volume tree.   Type: 
...
- [`Volume.display`](bpy.types.Volume.html#bpy.types.Volume.display)
