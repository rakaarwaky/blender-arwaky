...
[`VertexGroup`](bpy.types.VertexGroup.html#bpy.types.VertexGroup) | None
...
[`VertexGroup`](bpy.types.VertexGroup.html#bpy.types.VertexGroup)
...
group ([`VertexGroup`](bpy.types.VertexGroup.html#bpy.types.VertexGroup) | None) – Vertex group to remove (never None)
