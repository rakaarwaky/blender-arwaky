...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`ShaderNode`](bpy.types.ShaderNode.html#bpy.types.ShaderNode)
   ...
   class bpy.types.ShaderNodeBsdfSheen(ShaderNode) 
...
Sheen shading model (default `'ASHIKHMIN'`)

  
- `ASHIKHMIN` Ashikhmin – Classic Ashikhmin velvet (legacy model). 
- `MICROFIBER` Microfiber – Microflake-based model of multiple scattering between normal-oriented fibers.   Type: 

Literal[‘ASHIKHMIN’, ‘MICROFIBER’]
