...
Point coordinates (array of 4 items, in [-inf, inf], default (0.0, 0.0, 0.0, 0.0))
...
NURBS weight (in [-inf, inf], default 0.0)
...
- [`Spline.points`](bpy.types.Spline.html#bpy.types.Spline.points)
