...
- `RADIAL` Vignette – Use a radial gradient as viewport background.   Type: 
...
- [`ThemeSpaceGradient.gradients`](bpy.types.ThemeSpaceGradient.html#bpy.types.ThemeSpaceGradient.gradients)
