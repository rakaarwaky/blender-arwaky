...
- name (str) – Name, Name of the new export handler (optional, never None)   Returns: 
...
exporter ([`CollectionExport`](bpy.types.CollectionExport.html#bpy.types.CollectionExport) | None) – Export Handler to remove
