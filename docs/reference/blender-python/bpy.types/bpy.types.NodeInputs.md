...
base class — [`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection)
   ...
   class bpy.types.NodeInputs(bpy_prop_collection) 
...
- use_multi_input (bool) – Make the socket multi-input (valid for inputs only) (optional)   Returns: 

New socket

  Return type: 

[`NodeSocket`](bpy.types.NodeSocket.html#bpy.types.NodeSocket)
...
socket ([`NodeSocket`](bpy.types.NodeSocket.html#bpy.types.NodeSocket) | None) – The socket to remove
...
- to_index (int) – To Index, Target index for the socket (in [0, inf])       classmethod bl_rna_get_subclass(id, default=None, /)  Parameters:  
