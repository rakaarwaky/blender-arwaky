...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`ID`](bpy.types.ID.html#bpy.types.ID), [`Texture`](bpy.types.Texture.html#bpy.types.Texture)
...
- `SHARPER` Sharper – Use very clearly defined marble.   Type: 
...
- `CELL_NOISE` Cell Noise – Noise algorithm - Cell Noise: Square cell tessellation.   Type: 
...
- `TRI` Tri – Use a triangle wave to produce bands.   Type: 
...
- `HARD_NOISE` Hard – Generate hard noise (sharp transitions).   Type: 
...
- [`Texture.type`](bpy.types.Texture.html#bpy.types.Texture.type) 
- [`Texture.use_clamp`](bpy.types.Texture.html#bpy.types.Texture.use_clamp) 
- [`Texture.use_color_ramp`](bpy.types.Texture.html#bpy.types.Texture.use_color_ramp) 
- [`Texture.color_ramp`](bpy.types.Texture.html#bpy.types.Texture.color_ramp) 
- [`Texture.intensity`](bpy.types.Texture.html#bpy.types.Texture.intensity) 
- [`Texture.contrast`](bpy.types.Texture.html#bpy.types.Texture.contrast) 
- [`Texture.saturation`](bpy.types.Texture.html#bpy.types.Texture.saturation) 
- [`Texture.factor_red`](bpy.types.Texture.html#bpy.types.Texture.factor_red) 
- [`Texture.factor_green`](bpy.types.Texture.html#bpy.types.Texture.factor_green) 
- [`Texture.factor_blue`](bpy.types.Texture.html#bpy.types.Texture.factor_blue) 
- [`Texture.use_preview_alpha`](bpy.types.Texture.html#bpy.types.Texture.use_preview_alpha) 
- [`Texture.use_nodes`](bpy.types.Texture.html#bpy.types.Texture.use_nodes) 
...
- [`Texture.users_material`](bpy.types.Texture.html#bpy.types.Texture.users_material) 
- [`Texture.users_object_modifier`](bpy.types.Texture.html#bpy.types.Texture.users_object_modifier)     
...
- [`Texture.evaluate`](bpy.types.Texture.html#bpy.types.Texture.evaluate) 
- [`Texture.bl_rna_get_subclass`](bpy.types.Texture.html#bpy.types.Texture.bl_rna_get_subclass) 
- [`Texture.bl_rna_get_subclass_py`](bpy.types.Texture.html#bpy.types.Texture.bl_rna_get_subclass_py)
