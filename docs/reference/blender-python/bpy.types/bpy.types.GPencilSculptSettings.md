...
[`GPencilSculptGuide`](bpy.types.GPencilSculptGuide.html#bpy.types.GPencilSculptGuide) | None
...
- `CURSOR` Cursor – Align strokes to current 3D cursor orientation.   Type: 
...
- [`ToolSettings.gpencil_sculpt`](bpy.types.ToolSettings.html#bpy.types.ToolSettings.gpencil_sculpt)
