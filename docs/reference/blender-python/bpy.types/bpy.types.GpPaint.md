...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Paint`](bpy.types.Paint.html#bpy.types.Paint)
   ...
   class bpy.types.GpPaint(Paint)   color_mode 

Paint Mode (default `'MATERIAL'`)

  
- `MATERIAL` Material – Paint using the active material base color. 
- `VERTEXCOLOR` Color Attribute – Paint the material with a color attribute.   Type: 
...
- [`ToolSettings.gpencil_paint`](bpy.types.ToolSettings.html#bpy.types.ToolSettings.gpencil_paint)
