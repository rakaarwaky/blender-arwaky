...
- `FLOAT_VECTOR` Vector – 3D vector with floating-point values.   Type: 
...
Literal[[Node Map Range Items](bpy_types_enum_items/node_map_range_items.html#rna-enum-node-map-range-items)]
