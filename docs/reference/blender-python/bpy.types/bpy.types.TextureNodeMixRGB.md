...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct), [`Node`](bpy.types.Node.html#bpy.types.Node), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal), [`TextureNode`](bpy.types.TextureNode.html#bpy.types.TextureNode)
   ...
   class bpy.types.TextureNodeMixRGB(TextureNode)   blend_type 
...
Include alpha of second input in this operation (default False)
...
Clamp result of the node to 0.0 to 1.0 range (default False)
