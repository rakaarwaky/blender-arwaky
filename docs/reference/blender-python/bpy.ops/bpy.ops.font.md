...
- clear (bool) – Clear, Clear style rather than setting it (optional)   Returns: 
...
- accent (bool) – Accent Mode, Next typed character will strike through previous, for special character input (optional)   Returns: 
