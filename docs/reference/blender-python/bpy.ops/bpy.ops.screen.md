...
- sync (bool) – Sync, Drop frames to maintain framerate (optional)   Returns: 
...
- target_xy (Sequence[int]) – Target location, (array of 2 items, in [-inf, inf], optional)   Returns: 
...
- snap (bool) – Snapping, Enable snapping (optional)   Returns: 
...
- cursor (Sequence[int]) – Cursor, (array of 2 items, in [-inf, inf], optional)   Returns: 
...
set[Literal[[Operator Return Items](bpy_types_enum_items/operator_return_items.html#rna-enum-operator-return-items)]]
      ...
      bpy.ops.screen.edge_merge(*, cursor=(0, 0)) 
...
region_type (Literal[[Region Type Items](bpy_types_enum_items/region_type_items.html#rna-enum-region-type-items)]) – Region Type, Type of the region to toggle (optional)
...
space_type (Literal[[Space Type Items](bpy_types_enum_items/space_type_items.html#rna-enum-space-type-items)]) – Type, (optional)
...
section (Literal[[Preference Section Items](bpy_types_enum_items/preference_section_items.html#rna-enum-preference-section-items)]) – Section to activate in the Preferences (optional)
