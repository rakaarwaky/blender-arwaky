# info_gotchas_armatures_and_bones
...
`bpy.context.object.data.edit_bones` contains edit bones; to access them you must set the armature mode to Edit-Mode first (edit bones do not exist in Object or Pose-Mode). Use these to create new bones, set their head/tail or roll, change their parenting relationships to other bones, etc.

 

Example using [`bpy.types.EditBone`](bpy.types.EditBone.html#bpy.types.EditBone) in armature Edit-Mode which is only possible in Edit-Mode:
...
Example using [`bpy.types.Bone`](bpy.types.Bone.html#bpy.types.Bone) in Object or Pose-Mode returning a bone (not an edit bone) outside of Edit-Mode:
...
Examples using [`bpy.types.PoseBone`](bpy.types.PoseBone.html#bpy.types.PoseBone) in Object or Pose-Mode:
...
Strictly speaking pose bones are not bones, they are just the state of the armature, stored in the [`bpy.types.Object`](bpy.types.Object.html#bpy.types.Object) rather than the [`bpy.types.Armature`](bpy.types.Armature.html#bpy.types.Armature), yet the real bones are accessible from the pose bones via [`bpy.types.PoseBone.bone`](bpy.types.PoseBone.html#bpy.types.PoseBone.bone).
