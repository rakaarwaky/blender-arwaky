...
Combines robust path handling, multiple import strategies, and server state
checking so the TCP server can be launched both with and without the addon
formally enabled in user preferences.
"""
